...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 c6 77 10 80 	movl   $0x801077c6,(%esp)
...
80100d34:	e8 97 5d 00 00       	call   80106ad0 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 3f 61 00 00       	call   80106e80 <freevm>
  return 0;
...
8010123a:	e8 c1 32 00 00       	call   80104500 <acquire>
...
801012ca:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012cd:	e8 ee 32 00 00       	call   801045c0 <release>
      return ip;
...
801014a6:	e8 15 2f 00 00       	call   801043c0 <initlock>
...
8010166f:	e8 8c 2e 00 00       	call   80104500 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010167f:	e8 3c 2f 00 00       	call   801045c0 <release>
}
...
801017f6:	e8 05 2d 00 00       	call   80104500 <acquire>
  ip->ref--;
...
8010180f:	5d                   	pop    %ebp
  release(&icache.lock);
80101810:	e9 ab 2d 00 00       	jmp    801045c0 <release>
80101815:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101818:	83 ec 0c             	sub    $0xc,%esp
8010181b:	68 e0 09 11 80       	push   $0x801109e0
80101820:	e8 db 2c 00 00       	call   80104500 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010182f:	e8 8c 2d 00 00       	call   801045c0 <release>
    if(r == 1){
...
80101bae:	e8 7d 2b 00 00       	call   80104730 <strncmp>
}
80101bb3:	c9                   	leave  
80101bb4:	c3                   	ret    
...
80101c0d:	e8 1e 2b 00 00       	call   80104730 <strncmp>
      continue;
...
80101c99:	e8 62 28 00 00       	call   80104500 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101ca9:	e8 12 29 00 00       	call   801045c0 <release>
...
80101e8d:	e8 fe 28 00 00       	call   80104790 <strncpy>
  de.inum = inum;
...
80101ed8:	68 3a 79 10 80       	push   $0x8010793a
...
80102020:	e8 9b 23 00 00       	call   801043c0 <initlock>
...
8010209e:	e8 5d 24 00 00       	call   80104500 <acquire>
...
8010211f:	e8 9c 24 00 00       	call   801045c0 <release>
...
80102178:	e8 83 23 00 00       	call   80104500 <acquire>
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 d5 23 00 00       	jmp    801045c0 <release>
801021eb:	90                   	nop
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 30 22 00 00       	jmp    801045c0 <release>
    acquire(&kmem.lock);
80102390:	83 ec 0c             	sub    $0xc,%esp
80102393:	68 40 26 11 80       	push   $0x80112640
80102398:	e8 63 21 00 00       	call   80104500 <acquire>
...
80102415:	e8 a6 1f 00 00       	call   801043c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102503:	e8 f8 1f 00 00       	call   80104500 <acquire>
  r = kmem.freelist;
...
80102531:	e8 8a 20 00 00       	call   801045c0 <release>
  return (char*)r;
...
80102bbb:	e8 40 19 00 00       	call   80104500 <acquire>
...
80102c2e:	e8 cd 18 00 00       	call   80104500 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 4f 19 00 00       	call   801045c0 <release>
}
...
80102d0f:	e8 ec 17 00 00       	call   80104500 <acquire>
    wakeup(&log);
...
80102d31:	e8 8a 18 00 00       	call   801045c0 <release>
...
80102d5c:	e8 5f 18 00 00       	call   801045c0 <release>
...
80102dbe:	e8 3d 17 00 00       	call   80104500 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 ae 17 00 00       	jmp    801045c0 <release>
...
80102e72:	e8 49 2b 00 00       	call   801059c0 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 15 3c 00 00       	call   80106ab0 <switchkvm>
  seginit();
80102e9b:	e8 80 3b 00 00       	call   80106a20 <seginit>
  lapicinit();
...
80102ed1:	e8 aa 40 00 00       	call   80106f80 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 3b 3b 00 00       	call   80106a20 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 f7 2d 00 00       	call   80105cf0 <uartinit>
  pinit();         // process table
80102ef9:	e8 32 08 00 00       	call   80103730 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 3d 2a 00 00       	call   80105940 <tvinit>
  binit();         // buffer cache
...
80103203:	68 9d 76 10 80       	push   $0x8010769d
80103208:	e8 83 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010320d:	83 ec 0c             	sub    $0xc,%esp
80103210:	68 bc 76 10 80       	push   $0x801076bc
...
80103311:	e8 aa 10 00 00       	call   801043c0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 8c 11 00 00       	call   80104500 <acquire>
  if(writable){
...
801033b3:	5d                   	pop    %ebp
    release(&p->lock);
801033b4:	e9 07 12 00 00       	jmp    801045c0 <release>
...
801033e4:	e8 d7 11 00 00       	call   801045c0 <release>
    kfree((char*)p);
...
8010340d:	e8 ee 10 00 00       	call   80104500 <acquire>
  for(i = 0; i < n; i++){
...
801034a4:	e8 17 11 00 00       	call   801045c0 <release>
        return -1;
...
801034fb:	e8 c0 10 00 00       	call   801045c0 <release>
  return n;
...
80103520:	e8 db 0f 00 00       	call   80104500 <acquire>
...
8010358e:	e8 2d 10 00 00       	call   801045c0 <release>
      return -1;
...
801035ef:	e8 cc 0f 00 00       	call   801045c0 <release>
  return i;
...
80103621:	e8 da 0e 00 00       	call   80104500 <acquire>
...
8010365f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103665:	e8 56 0f 00 00       	call   801045c0 <release>
...
80103687:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010368a:	c7 40 14 27 59 10 80 	movl   $0x80105927,0x14(%eax)
  p->context = (struct context*)sp;
...
80103699:	e8 72 0f 00 00       	call   80104610 <memset>
...
801036eb:	e8 d0 0e 00 00       	call   801045c0 <release>
...
80103736:	68 f5 76 10 80       	push   $0x801076f5
8010373b:	68 20 2d 11 80       	push   $0x80112d20
80103740:	e8 7b 0c 00 00       	call   801043c0 <initlock>
}
...
801037f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037f7:	e8 34 0c 00 00       	call   80104430 <pushcli>
  c = mycpu();
801037fc:	e8 4f ff ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103801:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103807:	e8 64 0c 00 00       	call   80104470 <popcli>
}
...
80103833:	e8 c8 36 00 00       	call   80106f00 <setupkvm>
...
80103851:	e8 8a 33 00 00       	call   80106be0 <inituvm>
...
80103866:	e8 a5 0d 00 00       	call   80104610 <memset>
...
801038bf:	68 25 77 10 80       	push   $0x80107725
801038c4:	50                   	push   %eax
801038c5:	e8 26 0f 00 00       	call   801047f0 <safestrcpy>
  p->cwd = namei("/");
801038ca:	c7 04 24 2e 77 10 80 	movl   $0x8010772e,(%esp)
...
80103903:	68 0c 77 10 80       	push   $0x8010770c
...
80103915:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103918:	e8 13 0b 00 00       	call   80104430 <pushcli>
  c = mycpu();
8010391d:	e8 2e fe ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103922:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103928:	e8 43 0b 00 00       	call   80104470 <popcli>
  if(n > 0){
...
8010393c:	e8 8f 31 00 00       	call   80106ad0 <switchuvm>
  return 0;
...
8010395a:	e8 c1 33 00 00       	call   80106d20 <allocuvm>
...
8010397a:	e8 d1 34 00 00       	call   80106e50 <deallocuvm>
...
80103996:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103999:	e8 92 0a 00 00       	call   80104430 <pushcli>
  c = mycpu();
8010399e:	e8 ad fd ff ff       	call   80103750 <mycpu>
  p = c->proc;
801039a3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a9:	e8 c2 0a 00 00       	call   80104470 <popcli>
  if((np = allocproc()) == 0){
...
801039c8:	e8 03 36 00 00       	call   80106fd0 <copyuvm>
...
80103ade:	e8 1d 0a 00 00       	call   80104500 <acquire>
...
80103b00:	e8 cb 2f 00 00       	call   80106ad0 <switchuvm>
...
80103b0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b12:	e8 34 0d 00 00       	call   8010484b <swtch>
     p->csnum++;//1-(5) context switch count 
80103b17:	83 43 20 01          	addl   $0x1,0x20(%ebx)
      switchkvm();
80103b1b:	e8 90 2f 00 00       	call   80106ab0 <switchkvm>
      c->proc = 0;
80103b20:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b27:	00 00 00 
80103b2a:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b2d:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103b33:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103b39:	72 b5                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b3b:	83 ec 0c             	sub    $0xc,%esp
80103b3e:	68 20 2d 11 80       	push   $0x80112d20
80103b43:	e8 78 0a 00 00       	call   801045c0 <release>
    sti();
80103b48:	83 c4 10             	add    $0x10,%esp
80103b4b:	eb 83                	jmp    80103ad0 <scheduler+0x20>
...
80103bb3:	e8 93 0c 00 00       	call   8010484b <swtch>
  mycpu()->intena = intena;
...
80103c16:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c19:	e8 12 08 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103c1e:	e8 2d fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103c23:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c29:	e8 42 08 00 00       	call   80104470 <popcli>
  if(curproc == initproc)
...
80103c82:	e8 79 08 00 00       	call   80104500 <acquire>
...
80103caa:	3b 50 24             	cmp    0x24(%eax),%edx
...
80103d0a:	3b 48 24             	cmp    0x24(%eax),%ecx
...
80103d27:	68 7d 77 10 80       	push   $0x8010777d
80103d2c:	e8 5f c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d31:	83 ec 0c             	sub    $0xc,%esp
80103d34:	68 70 77 10 80       	push   $0x80107770
...
80103d4c:	e8 af 07 00 00       	call   80104500 <acquire>
  pushcli();
...
80103d79:	e8 42 08 00 00       	call   801045c0 <release>
}
...
80103d9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d9f:	e8 8c 06 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103da4:	e8 a7 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103da9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103daf:	e8 bc 06 00 00       	call   80104470 <popcli>
  if(p == 0)
...
80103dd0:	e8 2b 07 00 00       	call   80104500 <acquire>
    release(lk);
80103dd5:	89 34 24             	mov    %esi,(%esp)
80103dd8:	e8 e3 07 00 00       	call   801045c0 <release>
  p->chan = chan;
...
80103dfa:	e8 c1 07 00 00       	call   801045c0 <release>
    acquire(lk);
...
80103e0b:	5d                   	pop    %ebp
    acquire(lk);
80103e0c:	e9 ef 06 00 00       	jmp    80104500 <acquire>
...
80103e39:	68 8f 77 10 80       	push   $0x8010778f
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 89 77 10 80       	push   $0x80107789
...
80103e8e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80103eea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ef1:	e8 8a 2f 00 00       	call   80106e80 <freevm>
        release(&ptable.lock);
80103ef6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103efd:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f04:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f0b:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103f0f:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103f16:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f1d:	e8 9e 06 00 00       	call   801045c0 <release>
        return pid;
...
80103f31:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f36:	68 20 2d 11 80       	push   $0x80112d20
80103f3b:	e8 80 06 00 00       	call   801045c0 <release>
      return -1;
...
80103f5f:	e8 9c 05 00 00       	call   80104500 <acquire>
...
80103f82:	3b 58 24             	cmp    0x24(%eax),%ebx
...
80103f98:	72 e2                	jb     80103f7c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
80103f9a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103fa1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103fa4:	c9                   	leave  
  release(&ptable.lock);
80103fa5:	e9 16 06 00 00       	jmp    801045c0 <release>
...
80103fbf:	e8 3c 05 00 00       	call   80104500 <acquire>
...
80103fe1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80103fe5:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
80103ff8:	68 20 2d 11 80       	push   $0x80112d20
80103ffd:	e8 be 05 00 00       	call   801045c0 <release>
      return 0;
...
80104018:	e8 a3 05 00 00       	call   801045c0 <release>
  return -1;
...
8010404b:	68 c6 77 10 80       	push   $0x801077c6
80104050:	e8 0b c6 ff ff       	call   80100660 <cprintf>
80104055:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104058:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010405e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80104071:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104074:	ba a0 77 10 80       	mov    $0x801077a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104079:	77 11                	ja     8010408c <procdump+0x5c>
8010407b:	8b 14 85 1c 78 10 80 	mov    -0x7fef87e4(,%eax,4),%edx
      state = "???";
80104082:	b8 a0 77 10 80       	mov    $0x801077a0,%eax
80104087:	85 d2                	test   %edx,%edx
80104089:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010408c:	8d 43 70             	lea    0x70(%ebx),%eax
8010408f:	50                   	push   %eax
80104090:	52                   	push   %edx
80104091:	ff 73 10             	pushl  0x10(%ebx)
80104094:	68 a4 77 10 80       	push   $0x801077a4
...
801040bb:	e8 20 03 00 00       	call   801043e0 <getcallerpcs>
...
801040d9:	68 e1 71 10 80       	push   $0x801071e1
...
struct proc *p;
int count=0;
80104104:	31 db                	xor    %ebx,%ebx
{
80104106:	83 ec 10             	sub    $0x10,%esp

acquire(&ptable.lock);
80104109:	68 20 2d 11 80       	push   $0x80112d20
8010410e:	e8 ed 03 00 00       	call   80104500 <acquire>
80104113:	83 c4 10             	add    $0x10,%esp

for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104116:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
8010411b:	90                   	nop
8010411c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
{
if(p->state != UNUSED)
count++;
80104120:	83 7a 0c 01          	cmpl   $0x1,0xc(%edx)
80104124:	83 db ff             	sbb    $0xffffffff,%ebx
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104127:	81 c2 84 00 00 00    	add    $0x84,%edx
8010412d:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104133:	72 eb                	jb     80104120 <getnumproc+0x20>
}

release(&ptable.lock);
80104135:	83 ec 0c             	sub    $0xc,%esp
80104138:	68 20 2d 11 80       	push   $0x80112d20
8010413d:	e8 7e 04 00 00       	call   801045c0 <release>

return count;
}
80104142:	89 d8                	mov    %ebx,%eax
...
8010415e:	e8 9d 03 00 00       	call   80104500 <acquire>
...
80104175:	74 03                	je     8010417a <getmaxpid+0x2a>
      maxpid = p->pid;
80104177:	8b 5a 10             	mov    0x10(%edx),%ebx
  for(i=0,p=ptable.proc;p<&ptable.proc[NPROC];p++)
8010417a:	81 c2 84 00 00 00    	add    $0x84,%edx
80104180:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104186:	72 e8                	jb     80104170 <getmaxpid+0x20>
      i++;
    }
  }
  release(&ptable.lock);
...
80104190:	e8 2b 04 00 00       	call   801045c0 <release>
  return maxpid;
...
801041a5:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++)
801041a6:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
801041ab:	83 ec 18             	sub    $0x18,%esp
801041ae:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&ptable.lock);
801041b1:	68 20 2d 11 80       	push   $0x80112d20
801041b6:	e8 45 03 00 00       	call   80104500 <acquire>
801041bb:	83 c4 10             	add    $0x10,%esp
801041be:	66 90                	xchg   %ax,%ax
  {
    
    if(p->state != UNUSED){
801041c0:	8b 43 0c             	mov    0xc(%ebx),%eax
801041c3:	85 c0                	test   %eax,%eax
801041c5:	74 30                	je     801041f7 <getprocinfo+0x57>
      pid=p->pid;
      pI->ppid = p->parent!=0? p->parent->pid : 0;
801041c7:	8b 53 14             	mov    0x14(%ebx),%edx
801041ca:	31 c0                	xor    %eax,%eax
      pid=p->pid;
801041cc:	8b 7b 10             	mov    0x10(%ebx),%edi
      pI->ppid = p->parent!=0? p->parent->pid : 0;
801041cf:	85 d2                	test   %edx,%edx
801041d1:	74 03                	je     801041d6 <getprocinfo+0x36>
801041d3:	8b 42 10             	mov    0x10(%edx),%eax
801041d6:	89 06                	mov    %eax,(%esi)
      pI->psize = p->sz;
801041d8:	8b 13                	mov    (%ebx),%edx
      pI->numberContextSwitches=p->csnum;
      
     cprintf("%d      %d      %d    %d \n", pid, pI->ppid, pI->psize, pI->numberContextSwitches);
801041da:	83 ec 0c             	sub    $0xc,%esp
      pI->psize = p->sz;
801041dd:	89 56 04             	mov    %edx,0x4(%esi)
      pI->numberContextSwitches=p->csnum;
801041e0:	8b 4b 20             	mov    0x20(%ebx),%ecx
801041e3:	89 4e 08             	mov    %ecx,0x8(%esi)
     cprintf("%d      %d      %d    %d \n", pid, pI->ppid, pI->psize, pI->numberContextSwitches);
801041e6:	51                   	push   %ecx
801041e7:	52                   	push   %edx
801041e8:	50                   	push   %eax
801041e9:	57                   	push   %edi
801041ea:	68 ad 77 10 80       	push   $0x801077ad
801041ef:	e8 6c c4 ff ff       	call   80100660 <cprintf>
801041f4:	83 c4 20             	add    $0x20,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++)
801041f7:	81 c3 84 00 00 00    	add    $0x84,%ebx
801041fd:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104203:	72 bb                	jb     801041c0 <getprocinfo+0x20>
...
8010420d:	e8 ae 03 00 00       	call   801045c0 <release>
   
  return 0;
}
80104212:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
8010422b:	e8 d0 02 00 00       	call   80104500 <acquire>
80104230:	83 c4 10             	add    $0x10,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++)
80104233:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104238:	eb 12                	jmp    8010424c <setprio+0x2c>
8010423a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104240:	05 84 00 00 00       	add    $0x84,%eax
80104245:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010424a:	73 14                	jae    80104260 <setprio+0x40>
  {
    
    if(p->state != UNUSED){
8010424c:	8b 50 0c             	mov    0xc(%eax),%edx
8010424f:	85 d2                	test   %edx,%edx
80104251:	74 ed                	je     80104240 <setprio+0x20>
      p->priority = n;
80104253:	8b 55 08             	mov    0x8(%ebp),%edx
80104256:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
      return 0;
...
80104268:	e8 53 03 00 00       	call   801045c0 <release>
  return -1;
...
8010429a:	68 34 78 10 80       	push   $0x80107834
...
801042f5:	e8 96 fa ff ff       	call   80103d90 <sleep>
  while (lk->locked) {
...
80104303:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104309:	e8 e2 f4 ff ff       	call   801037f0 <myproc>
...
80104354:	e8 f7 fb ff ff       	call   80103f50 <wakeup>
  release(&lk->lk);
...
80104393:	e8 58 f4 ff ff       	call   801037f0 <myproc>
...
8010444f:	e8 fc f2 ff ff       	call   80103750 <mycpu>
80104454:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010445a:	e8 f1 f2 ff ff       	call   80103750 <mycpu>
...
8010449c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a0:	e8 ab f2 ff ff       	call   80103750 <mycpu>
...
801044b5:	68 3f 78 10 80       	push   $0x8010783f
801044ba:	e8 d1 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044bf:	83 ec 0c             	sub    $0xc,%esp
801044c2:	68 56 78 10 80       	push   $0x80107856
...
801044e8:	e8 63 f2 ff ff       	call   80103750 <mycpu>
...
80104544:	e8 07 f2 ff ff       	call   80103750 <mycpu>
...
801045a7:	68 5d 78 10 80       	push   $0x8010785d
...
801045fc:	68 65 78 10 80       	push   $0x80107865
...
80104867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010486a:	e8 81 ef ff ff       	call   801037f0 <myproc>
...
801048a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048aa:	e8 41 ef ff ff       	call   801037f0 <myproc>
...
80104915:	e8 d6 ee ff ff       	call   801037f0 <myproc>
...
80104923:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104926:	e8 c5 ee ff ff       	call   801037f0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104968:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010496b:	e8 80 ee ff ff       	call   801037f0 <myproc>
...
80104a04:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a07:	e8 e4 ed ff ff       	call   801037f0 <myproc>
...
80104a17:	83 fa 1b             	cmp    $0x1b,%edx
80104a1a:	77 1c                	ja     80104a38 <syscall+0x38>
80104a1c:	8b 14 85 a0 78 10 80 	mov    -0x7fef8760(,%eax,4),%edx
...
80104a38:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104a39:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104a3c:	50                   	push   %eax
80104a3d:	ff 73 10             	pushl  0x10(%ebx)
80104a40:	68 6d 78 10 80       	push   $0x8010786d
...
80104a77:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a7a:	e8 91 d4 ff ff       	call   80101f10 <nameiparent>
...
80104a9e:	e8 1d d1 ff ff       	call   80101bc0 <dirlookup>
80104aa3:	83 c4 10             	add    $0x10,%esp
80104aa6:	85 c0                	test   %eax,%eax
80104aa8:	89 c7                	mov    %eax,%edi
80104aaa:	74 34                	je     80104ae0 <create+0x80>
    iunlockput(dp);
80104aac:	83 ec 0c             	sub    $0xc,%esp
80104aaf:	53                   	push   %ebx
80104ab0:	e8 6b ce ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104ab5:	89 3c 24             	mov    %edi,(%esp)
80104ab8:	e8 d3 cb ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104abd:	83 c4 10             	add    $0x10,%esp
80104ac0:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104ac5:	0f 85 95 00 00 00    	jne    80104b60 <create+0x100>
80104acb:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104ad0:	0f 85 8a 00 00 00    	jne    80104b60 <create+0x100>
...
80104ad6:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104ad9:	89 f8                	mov    %edi,%eax
80104adb:	5b                   	pop    %ebx
80104adc:	5e                   	pop    %esi
80104add:	5f                   	pop    %edi
80104ade:	5d                   	pop    %ebp
...
80104aea:	e8 31 ca ff ff       	call   80101520 <ialloc>
...
80104b00:	e8 8b cb ff ff       	call   80101690 <ilock>
  ip->major = major;
...
80104b21:	e8 ba ca ff ff       	call   801015e0 <iupdate>
...
80104b38:	e8 f3 d2 ff ff       	call   80101e30 <dirlink>
...
80104b4c:	e8 cf cd ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104b64:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104b66:	e8 b5 cd ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104b89:	e8 52 ca ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b8e:	83 c4 0c             	add    $0xc,%esp
80104b91:	ff 77 04             	pushl  0x4(%edi)
80104b94:	68 30 79 10 80       	push   $0x80107930
80104b99:	57                   	push   %edi
80104b9a:	e8 91 d2 ff ff       	call   80101e30 <dirlink>
...
80104bac:	68 2f 79 10 80       	push   $0x8010792f
80104bb1:	57                   	push   %edi
80104bb2:	e8 79 d2 ff ff       	call   80101e30 <dirlink>
...
80104c24:	e8 c7 eb ff ff       	call   801037f0 <myproc>
80104c29:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c2c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104c69:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c6b:	e8 80 eb ff ff       	call   801037f0 <myproc>
...
80104c80:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104c84:	85 d2                	test   %edx,%edx
80104c86:	75 f0                	jne    80104c78 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104c88:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104db3:	78 2b                	js     80104de0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104db5:	e8 36 ea ff ff       	call   801037f0 <myproc>
...
80104e83:	e8 68 d0 ff ff       	call   80101ef0 <namei>
...
80104eb8:	e8 23 c7 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104ebd:	89 1c 24             	mov    %ebx,(%esp)
80104ec0:	e8 ab c8 ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ec5:	58                   	pop    %eax
80104ec6:	5a                   	pop    %edx
80104ec7:	57                   	push   %edi
80104ec8:	ff 75 d0             	pushl  -0x30(%ebp)
80104ecb:	e8 40 d0 ff ff       	call   80101f10 <nameiparent>
...
80104edd:	e8 ae c7 ff ff       	call   80101690 <ilock>
...
80104ef3:	e8 38 cf ff ff       	call   80101e30 <dirlink>
...
80104f03:	e8 18 ca ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104f08:	89 1c 24             	mov    %ebx,(%esp)
80104f0b:	e8 b0 c8 ff ff       	call   801017c0 <iput>
  end_op();
...
80104f6b:	e8 b0 c9 ff ff       	call   80101920 <iunlockput>
    end_op();
80104f70:	e8 ab dc ff ff       	call   80102c20 <end_op>
    return -1;
80104f75:	83 c4 10             	add    $0x10,%esp
80104f78:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f7d:	eb 9b                	jmp    80104f1a <sys_link+0xda>
    end_op();
80104f7f:	e8 9c dc ff ff       	call   80102c20 <end_op>
    return -1;
...
80104faf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104fb2:	e8 f9 db ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104fb7:	83 ec 08             	sub    $0x8,%esp
80104fba:	53                   	push   %ebx
80104fbb:	ff 75 c0             	pushl  -0x40(%ebp)
80104fbe:	e8 4d cf ff ff       	call   80101f10 <nameiparent>
...
80104fd4:	e8 b7 c6 ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104fd9:	58                   	pop    %eax
80104fda:	5a                   	pop    %edx
80104fdb:	68 30 79 10 80       	push   $0x80107930
80104fe0:	53                   	push   %ebx
80104fe1:	e8 ba cb ff ff       	call   80101ba0 <namecmp>
...
80104ff4:	68 2f 79 10 80       	push   $0x8010792f
80104ff9:	53                   	push   %ebx
80104ffa:	e8 a1 cb ff ff       	call   80101ba0 <namecmp>
...
80105013:	e8 a8 cb ff ff       	call   80101bc0 <dirlookup>
...
8010505d:	e8 0e ca ff ff       	call   80101a70 <writei>
...
8010507d:	e8 9e c8 ff ff       	call   80101920 <iunlockput>
  ip->nlink--;
80105082:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105087:	89 1c 24             	mov    %ebx,(%esp)
8010508a:	e8 51 c5 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
8010508f:	89 1c 24             	mov    %ebx,(%esp)
80105092:	e8 89 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
80105097:	e8 84 db ff ff       	call   80102c20 <end_op>
  return 0;
...
801050d4:	e8 97 c8 ff ff       	call   80101970 <readi>
...
801050f8:	e8 23 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
...
80105119:	e8 c2 c4 ff ff       	call   801015e0 <iupdate>
...
801051a2:	0f 88 04 01 00 00    	js     801052ac <sys_open+0x13c>
  ...
  begin_op();
801051a8:	e8 03 da ff ff       	call   80102bb0 <begin_op>
...
801051bd:	e8 2e cd ff ff       	call   80101ef0 <namei>
...
801051d3:	e8 b8 c4 ff ff       	call   80101690 <ilock>
...
801051ef:	0f 84 a6 00 00 00    	je     8010529b <sys_open+0x12b>
  struct proc *curproc = myproc();
801051f5:	e8 f6 e5 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010521c:	e8 4f c5 ff ff       	call   80101770 <iunlock>
  end_op();
...
8010527b:	0f 85 65 ff ff ff    	jne    801051e6 <sys_open+0x76>
      end_op();
80105281:	e8 9a d9 ff ff       	call   80102c20 <end_op>
      return -1;
...
8010530f:	e8 0c c6 ff ff       	call   80101920 <iunlockput>
  end_op();
80105314:	e8 07 d9 ff ff       	call   80102c20 <end_op>
  return 0;
...
80105333:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105336:	e8 75 d8 ff ff       	call   80102bb0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010539e:	e8 7d c5 ff ff       	call   80101920 <iunlockput>
  end_op();
801053a3:	e8 78 d8 ff ff       	call   80102c20 <end_op>
  return 0;
...
801053c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801053c8:	e8 23 e4 ff ff       	call   801037f0 <myproc>
801053cd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801053cf:	e8 dc d7 ff ff       	call   80102bb0 <begin_op>
...
801053ef:	e8 fc ca ff ff       	call   80101ef0 <namei>
...
80105401:	e8 8a c2 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
80105414:	e8 57 c3 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
80105419:	58                   	pop    %eax
8010541a:	ff 76 6c             	pushl  0x6c(%esi)
8010541d:	e8 9e c3 ff ff       	call   801017c0 <iput>
  end_op();
80105422:	e8 f9 d7 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
80105444:	e8 d7 c4 ff ff       	call   80101920 <iunlockput>
    end_op();
80105449:	e8 d2 d7 ff ff       	call   80102c20 <end_op>
    return -1;
...
8010558c:	e8 bf dc ff ff       	call   80103250 <pipealloc>
...
8010559f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055a1:	e8 4a e2 ff ff       	call   801037f0 <myproc>
...
801055c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055ca:	e8 21 e2 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105601:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105608:	e8 e3 e1 ff ff       	call   801037f0 <myproc>
...
80105643:	5d                   	pop    %ebp
  return fork();
80105644:	e9 47 e3 ff ff       	jmp    80103990 <fork>
...
80105653:	83 ec 08             	sub    $0x8,%esp
  exit();
80105656:	e8 b5 e5 ff ff       	call   80103c10 <exit>
...
80105663:	5d                   	pop    %ebp
  return wait();
80105664:	e9 e7 e7 ff ff       	jmp    80103e50 <wait>
...
8010568e:	e8 1d e9 ff ff       	call   80103fb0 <kill>
...
801056b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056b6:	e8 35 e1 ff ff       	call   801037f0 <myproc>
...
801056d7:	78 27                	js     80105700 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801056d9:	e8 12 e1 ff ff       	call   801037f0 <myproc>
  if(growproc(n) < 0)
...
801056e6:	e8 25 e2 ff ff       	call   80103910 <growproc>
...
80105730:	68 60 4e 11 80       	push   $0x80114e60
...
8010573d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105740:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
80105753:	68 60 4e 11 80       	push   $0x80114e60
80105758:	68 a0 56 11 80       	push   $0x801156a0
8010575d:	e8 2e e6 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
80105762:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
801057a3:	68 60 4e 11 80       	push   $0x80114e60
...
801057c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801057c7:	68 60 4e 11 80       	push   $0x80114e60
801057cc:	e8 2f ed ff ff       	call   80104500 <acquire>
  xticks = ticks;
801057d1:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
801057d7:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
...
801057f3:	83 ec 14             	sub    $0x14,%esp
cprintf("helloxv6\n");
801057f6:	68 75 79 10 80       	push   $0x80107975
...
80105816:	8d 45 08             	lea    0x8(%ebp),%eax
...
80105823:	58                   	pop    %eax
80105824:	5a                   	pop    %edx
80105825:	ff 75 08             	pushl  0x8(%ebp)
80105828:	68 7f 79 10 80       	push   $0x8010797f
...
80105846:	e8 b5 e8 ff ff       	call   80104100 <getnumproc>
8010584b:	83 ec 08             	sub    $0x8,%esp
8010584e:	50                   	push   %eax
8010584f:	68 9c 79 10 80       	push   $0x8010799c
...
80105866:	e8 e5 e8 ff ff       	call   80104150 <getmaxpid>
8010586b:	83 ec 08             	sub    $0x8,%esp
8010586e:	50                   	push   %eax
8010586f:	68 89 79 10 80       	push   $0x80107989
...
80105880 <sys_getprocinfo>:
int 
sys_getprocinfo(void)
{
80105880:	55                   	push   %ebp
80105881:	89 e5                	mov    %esp,%ebp
80105883:	83 ec 24             	sub    $0x24,%esp
  cprintf("PID    PPID   SIZE    Number of Context Switch\n");
80105886:	68 c4 79 10 80       	push   $0x801079c4
...
80105898:	e8 73 f0 ff ff       	call   80104910 <argint>
8010589d:	83 c4 10             	add    $0x10,%esp
801058a0:	85 c0                	test   %eax,%eax
801058a2:	78 2c                	js     801058d0 <sys_getprocinfo+0x50>
801058a4:	8d 45 f4             	lea    -0xc(%ebp),%eax
801058a7:	83 ec 04             	sub    $0x4,%esp
801058aa:	6a 0c                	push   $0xc
801058ac:	50                   	push   %eax
801058ad:	6a 01                	push   $0x1
801058af:	e8 ac f0 ff ff       	call   80104960 <argptr>
801058b4:	83 c4 10             	add    $0x10,%esp
801058b7:	85 c0                	test   %eax,%eax
801058b9:	78 15                	js     801058d0 <sys_getprocinfo+0x50>
      return -1;
  getprocinfo(pid, tmp);
801058bb:	83 ec 08             	sub    $0x8,%esp
801058be:	ff 75 f4             	pushl  -0xc(%ebp)
801058c1:	ff 75 f0             	pushl  -0x10(%ebp)
801058c4:	e8 d7 e8 ff ff       	call   801041a0 <getprocinfo>
...
801058ec:	e8 1f f0 ff ff       	call   80104910 <argint>
  setprio(n);
801058f1:	58                   	pop    %eax
801058f2:	ff 75 f4             	pushl  -0xc(%ebp)
801058f5:	e8 26 e9 ff ff       	call   80104220 <setprio>
  return 0;
}
801058fa:	31 c0                	xor    %eax,%eax
801058fc:	c9                   	leave  
801058fd:	c3                   	ret    
801058fe:	66 90                	xchg   %ax,%ax

80105900 <sys_getprio>:
...
80105903:	83 ec 08             	sub    $0x8,%esp
  getprio();
80105906:	e8 75 e9 ff ff       	call   80104280 <getprio>
  return 0;
}
...
80105910:	06                   	push   %es
  pushl %fs
80105911:	0f a0                	push   %fs
  pushl %gs
80105913:	0f a8                	push   %gs
  pushal
80105915:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105916:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010591a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010591c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010591e:	54                   	push   %esp
  call trap
8010591f:	e8 cc 00 00 00       	call   801059f0 <trap>
  addl $4, %esp
80105924:	83 c4 04             	add    $0x4,%esp
...
80105927:	61                   	popa   
  popl %gs
80105928:	0f a9                	pop    %gs
  popl %fs
8010592a:	0f a1                	pop    %fs
  popl %es
8010592c:	07                   	pop    %es
  popl %ds
8010592d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010592e:	83 c4 08             	add    $0x8,%esp
  iret
80105931:	cf                   	iret   
80105932:	66 90                	xchg   %ax,%ax
...
80105957:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
8010595e:	08 00 00 8e 
80105962:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105969:	80 
8010596a:	c1 ea 10             	shr    $0x10,%edx
8010596d:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105974:	80 
  for(i = 0; i < 256; i++)
...
80105984:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105987:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 f4 79 10 80       	push   $0x801079f4
80105996:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010599b:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
801059a1:	c1 e8 10             	shr    $0x10,%eax
801059a4:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
801059aa:	e8 11 ea ff ff       	call   801043c0 <initlock>
}
...
801059cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059cf:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105a10:	ff 24 85 9c 7a 10 80 	jmp    *-0x7fef8564(,%eax,4)
...
80105a20:	e8 cb dd ff ff       	call   801037f0 <myproc>
...
80105a40:	e8 8b dd ff ff       	call   801037d0 <cpuid>
...
80105a51:	e8 9a dd ff ff       	call   801037f0 <myproc>
...
80105a6d:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105a6e:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a71:	52                   	push   %edx
80105a72:	ff 70 10             	pushl  0x10(%eax)
80105a75:	68 58 7a 10 80       	push   $0x80107a58
80105a7a:	e8 e1 ab ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105a7f:	83 c4 20             	add    $0x20,%esp
80105a82:	e8 69 dd ff ff       	call   801037f0 <myproc>
80105a87:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105ab4:	e8 37 dd ff ff       	call   801037f0 <myproc>
80105ab9:	85 c0                	test   %eax,%eax
80105abb:	74 0b                	je     80105ac8 <trap+0xd8>
80105abd:	e8 2e dd ff ff       	call   801037f0 <myproc>
...
80105ac6:	74 68                	je     80105b30 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ac8:	e8 23 dd ff ff       	call   801037f0 <myproc>
80105acd:	85 c0                	test   %eax,%eax
80105acf:	74 19                	je     80105aea <trap+0xfa>
80105ad1:	e8 1a dd ff ff       	call   801037f0 <myproc>
...
80105afd:	8b 58 28             	mov    0x28(%eax),%ebx
80105b00:	85 db                	test   %ebx,%ebx
80105b02:	0f 85 e8 00 00 00    	jne    80105bf0 <trap+0x200>
    myproc()->tf = tf;
80105b08:	e8 e3 dc ff ff       	call   801037f0 <myproc>
80105b0d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b10:	e8 eb ee ff ff       	call   80104a00 <syscall>
    if(myproc()->killed)
80105b15:	e8 d6 dc ff ff       	call   801037f0 <myproc>
80105b1a:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105b4d:	e8 0e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b52:	e8 99 dc ff ff       	call   801037f0 <myproc>
...
80105b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b68:	e8 b3 ca ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105b6d:	e8 ee cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b72:	e8 79 dc ff ff       	call   801037f0 <myproc>
...
80105b8d:	e8 ce cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b92:	e8 59 dc ff ff       	call   801037f0 <myproc>
...
80105baf:	e8 1c dc ff ff       	call   801037d0 <cpuid>
80105bb4:	56                   	push   %esi
80105bb5:	53                   	push   %ebx
80105bb6:	50                   	push   %eax
80105bb7:	68 00 7a 10 80       	push   $0x80107a00
80105bbc:	e8 9f aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105bc1:	e8 9a cb ff ff       	call   80102760 <lapiceoi>
    break;
...
80105c44:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c47:	e8 84 db ff ff       	call   801037d0 <cpuid>
...
80105c55:	68 24 7a 10 80       	push   $0x80107a24
80105c5a:	e8 01 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c5f:	83 c4 14             	add    $0x14,%esp
80105c62:	68 f9 79 10 80       	push   $0x801079f9
...
80105cc5:	e8 b6 ca ff ff       	call   80102780 <microdelay>
...
80105d5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d5f:	bb 1c 7b 10 80       	mov    $0x80107b1c,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d64:	6a 00                	push   $0x0
80105d66:	6a 04                	push   $0x4
80105d68:	e8 73 c5 ff ff       	call   801022e0 <ioapicenable>
...
80105df7:	6a 00                	push   $0x0
  jmp alltraps
80105df9:	e9 11 fb ff ff       	jmp    8010590f <alltraps>
...
80105e00:	6a 01                	push   $0x1
  jmp alltraps
80105e02:	e9 08 fb ff ff       	jmp    8010590f <alltraps>
...
80105e09:	6a 02                	push   $0x2
  jmp alltraps
80105e0b:	e9 ff fa ff ff       	jmp    8010590f <alltraps>
...
80105e12:	6a 03                	push   $0x3
  jmp alltraps
80105e14:	e9 f6 fa ff ff       	jmp    8010590f <alltraps>
...
80105e1b:	6a 04                	push   $0x4
  jmp alltraps
80105e1d:	e9 ed fa ff ff       	jmp    8010590f <alltraps>
...
80105e24:	6a 05                	push   $0x5
  jmp alltraps
80105e26:	e9 e4 fa ff ff       	jmp    8010590f <alltraps>
...
80105e2d:	6a 06                	push   $0x6
  jmp alltraps
80105e2f:	e9 db fa ff ff       	jmp    8010590f <alltraps>
...
80105e36:	6a 07                	push   $0x7
  jmp alltraps
80105e38:	e9 d2 fa ff ff       	jmp    8010590f <alltraps>
...
80105e3d:	6a 08                	push   $0x8
  jmp alltraps
80105e3f:	e9 cb fa ff ff       	jmp    8010590f <alltraps>
...
80105e46:	6a 09                	push   $0x9
  jmp alltraps
80105e48:	e9 c2 fa ff ff       	jmp    8010590f <alltraps>
...
80105e4d:	6a 0a                	push   $0xa
  jmp alltraps
80105e4f:	e9 bb fa ff ff       	jmp    8010590f <alltraps>
...
80105e54:	6a 0b                	push   $0xb
  jmp alltraps
80105e56:	e9 b4 fa ff ff       	jmp    8010590f <alltraps>
...
80105e5b:	6a 0c                	push   $0xc
  jmp alltraps
80105e5d:	e9 ad fa ff ff       	jmp    8010590f <alltraps>
...
80105e62:	6a 0d                	push   $0xd
  jmp alltraps
80105e64:	e9 a6 fa ff ff       	jmp    8010590f <alltraps>
...
80105e69:	6a 0e                	push   $0xe
  jmp alltraps
80105e6b:	e9 9f fa ff ff       	jmp    8010590f <alltraps>
...
80105e72:	6a 0f                	push   $0xf
  jmp alltraps
80105e74:	e9 96 fa ff ff       	jmp    8010590f <alltraps>
...
80105e7b:	6a 10                	push   $0x10
  jmp alltraps
80105e7d:	e9 8d fa ff ff       	jmp    8010590f <alltraps>
...
80105e82:	6a 11                	push   $0x11
  jmp alltraps
80105e84:	e9 86 fa ff ff       	jmp    8010590f <alltraps>
...
80105e8b:	6a 12                	push   $0x12
  jmp alltraps
80105e8d:	e9 7d fa ff ff       	jmp    8010590f <alltraps>
...
80105e94:	6a 13                	push   $0x13
  jmp alltraps
80105e96:	e9 74 fa ff ff       	jmp    8010590f <alltraps>
...
80105e9d:	6a 14                	push   $0x14
  jmp alltraps
80105e9f:	e9 6b fa ff ff       	jmp    8010590f <alltraps>
...
80105ea6:	6a 15                	push   $0x15
  jmp alltraps
80105ea8:	e9 62 fa ff ff       	jmp    8010590f <alltraps>
...
80105eaf:	6a 16                	push   $0x16
  jmp alltraps
80105eb1:	e9 59 fa ff ff       	jmp    8010590f <alltraps>
...
80105eb8:	6a 17                	push   $0x17
  jmp alltraps
80105eba:	e9 50 fa ff ff       	jmp    8010590f <alltraps>
...
80105ec1:	6a 18                	push   $0x18
  jmp alltraps
80105ec3:	e9 47 fa ff ff       	jmp    8010590f <alltraps>
...
80105eca:	6a 19                	push   $0x19
  jmp alltraps
80105ecc:	e9 3e fa ff ff       	jmp    8010590f <alltraps>
...
80105ed3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ed5:	e9 35 fa ff ff       	jmp    8010590f <alltraps>
...
80105edc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ede:	e9 2c fa ff ff       	jmp    8010590f <alltraps>
...
80105ee5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ee7:	e9 23 fa ff ff       	jmp    8010590f <alltraps>
...
80105eee:	6a 1d                	push   $0x1d
  jmp alltraps
80105ef0:	e9 1a fa ff ff       	jmp    8010590f <alltraps>
...
80105ef7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ef9:	e9 11 fa ff ff       	jmp    8010590f <alltraps>
...
80105f00:	6a 1f                	push   $0x1f
  jmp alltraps
80105f02:	e9 08 fa ff ff       	jmp    8010590f <alltraps>
...
80105f09:	6a 20                	push   $0x20
  jmp alltraps
80105f0b:	e9 ff f9 ff ff       	jmp    8010590f <alltraps>
...
80105f12:	6a 21                	push   $0x21
  jmp alltraps
80105f14:	e9 f6 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f1b:	6a 22                	push   $0x22
  jmp alltraps
80105f1d:	e9 ed f9 ff ff       	jmp    8010590f <alltraps>
...
80105f24:	6a 23                	push   $0x23
  jmp alltraps
80105f26:	e9 e4 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f2d:	6a 24                	push   $0x24
  jmp alltraps
80105f2f:	e9 db f9 ff ff       	jmp    8010590f <alltraps>
...
80105f36:	6a 25                	push   $0x25
  jmp alltraps
80105f38:	e9 d2 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f3f:	6a 26                	push   $0x26
  jmp alltraps
80105f41:	e9 c9 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f48:	6a 27                	push   $0x27
  jmp alltraps
80105f4a:	e9 c0 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f51:	6a 28                	push   $0x28
  jmp alltraps
80105f53:	e9 b7 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f5a:	6a 29                	push   $0x29
  jmp alltraps
80105f5c:	e9 ae f9 ff ff       	jmp    8010590f <alltraps>
...
80105f63:	6a 2a                	push   $0x2a
  jmp alltraps
80105f65:	e9 a5 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f6e:	e9 9c f9 ff ff       	jmp    8010590f <alltraps>
...
80105f75:	6a 2c                	push   $0x2c
  jmp alltraps
80105f77:	e9 93 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f80:	e9 8a f9 ff ff       	jmp    8010590f <alltraps>
...
80105f87:	6a 2e                	push   $0x2e
  jmp alltraps
80105f89:	e9 81 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f90:	6a 2f                	push   $0x2f
  jmp alltraps
80105f92:	e9 78 f9 ff ff       	jmp    8010590f <alltraps>
...
80105f99:	6a 30                	push   $0x30
  jmp alltraps
80105f9b:	e9 6f f9 ff ff       	jmp    8010590f <alltraps>
...
80105fa2:	6a 31                	push   $0x31
  jmp alltraps
80105fa4:	e9 66 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fab:	6a 32                	push   $0x32
  jmp alltraps
80105fad:	e9 5d f9 ff ff       	jmp    8010590f <alltraps>
...
80105fb4:	6a 33                	push   $0x33
  jmp alltraps
80105fb6:	e9 54 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fbd:	6a 34                	push   $0x34
  jmp alltraps
80105fbf:	e9 4b f9 ff ff       	jmp    8010590f <alltraps>
...
80105fc6:	6a 35                	push   $0x35
  jmp alltraps
80105fc8:	e9 42 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fcf:	6a 36                	push   $0x36
  jmp alltraps
80105fd1:	e9 39 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fd8:	6a 37                	push   $0x37
  jmp alltraps
80105fda:	e9 30 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fe1:	6a 38                	push   $0x38
  jmp alltraps
80105fe3:	e9 27 f9 ff ff       	jmp    8010590f <alltraps>
...
80105fea:	6a 39                	push   $0x39
  jmp alltraps
80105fec:	e9 1e f9 ff ff       	jmp    8010590f <alltraps>
...
80105ff3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ff5:	e9 15 f9 ff ff       	jmp    8010590f <alltraps>
...
80105ffc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ffe:	e9 0c f9 ff ff       	jmp    8010590f <alltraps>
...
80106005:	6a 3c                	push   $0x3c
  jmp alltraps
80106007:	e9 03 f9 ff ff       	jmp    8010590f <alltraps>
...
8010600e:	6a 3d                	push   $0x3d
  jmp alltraps
80106010:	e9 fa f8 ff ff       	jmp    8010590f <alltraps>
...
80106017:	6a 3e                	push   $0x3e
  jmp alltraps
80106019:	e9 f1 f8 ff ff       	jmp    8010590f <alltraps>
...
80106020:	6a 3f                	push   $0x3f
  jmp alltraps
80106022:	e9 e8 f8 ff ff       	jmp    8010590f <alltraps>
...
80106029:	6a 40                	push   $0x40
  jmp alltraps
8010602b:	e9 df f8 ff ff       	jmp    8010590f <alltraps>
...
80106032:	6a 41                	push   $0x41
  jmp alltraps
80106034:	e9 d6 f8 ff ff       	jmp    8010590f <alltraps>
...
8010603b:	6a 42                	push   $0x42
  jmp alltraps
8010603d:	e9 cd f8 ff ff       	jmp    8010590f <alltraps>
...
80106044:	6a 43                	push   $0x43
  jmp alltraps
80106046:	e9 c4 f8 ff ff       	jmp    8010590f <alltraps>
...
8010604d:	6a 44                	push   $0x44
  jmp alltraps
8010604f:	e9 bb f8 ff ff       	jmp    8010590f <alltraps>
...
80106056:	6a 45                	push   $0x45
  jmp alltraps
80106058:	e9 b2 f8 ff ff       	jmp    8010590f <alltraps>
...
8010605f:	6a 46                	push   $0x46
  jmp alltraps
80106061:	e9 a9 f8 ff ff       	jmp    8010590f <alltraps>
...
80106068:	6a 47                	push   $0x47
  jmp alltraps
8010606a:	e9 a0 f8 ff ff       	jmp    8010590f <alltraps>
...
80106071:	6a 48                	push   $0x48
  jmp alltraps
80106073:	e9 97 f8 ff ff       	jmp    8010590f <alltraps>
...
8010607a:	6a 49                	push   $0x49
  jmp alltraps
8010607c:	e9 8e f8 ff ff       	jmp    8010590f <alltraps>
...
80106083:	6a 4a                	push   $0x4a
  jmp alltraps
80106085:	e9 85 f8 ff ff       	jmp    8010590f <alltraps>
...
8010608c:	6a 4b                	push   $0x4b
  jmp alltraps
8010608e:	e9 7c f8 ff ff       	jmp    8010590f <alltraps>
...
80106095:	6a 4c                	push   $0x4c
  jmp alltraps
80106097:	e9 73 f8 ff ff       	jmp    8010590f <alltraps>
...
8010609e:	6a 4d                	push   $0x4d
  jmp alltraps
801060a0:	e9 6a f8 ff ff       	jmp    8010590f <alltraps>
...
801060a7:	6a 4e                	push   $0x4e
  jmp alltraps
801060a9:	e9 61 f8 ff ff       	jmp    8010590f <alltraps>
...
801060b0:	6a 4f                	push   $0x4f
  jmp alltraps
801060b2:	e9 58 f8 ff ff       	jmp    8010590f <alltraps>
...
801060b9:	6a 50                	push   $0x50
  jmp alltraps
801060bb:	e9 4f f8 ff ff       	jmp    8010590f <alltraps>
...
801060c2:	6a 51                	push   $0x51
  jmp alltraps
801060c4:	e9 46 f8 ff ff       	jmp    8010590f <alltraps>
...
801060cb:	6a 52                	push   $0x52
  jmp alltraps
801060cd:	e9 3d f8 ff ff       	jmp    8010590f <alltraps>
...
801060d4:	6a 53                	push   $0x53
  jmp alltraps
801060d6:	e9 34 f8 ff ff       	jmp    8010590f <alltraps>
...
801060dd:	6a 54                	push   $0x54
  jmp alltraps
801060df:	e9 2b f8 ff ff       	jmp    8010590f <alltraps>
...
801060e6:	6a 55                	push   $0x55
  jmp alltraps
801060e8:	e9 22 f8 ff ff       	jmp    8010590f <alltraps>
...
801060ef:	6a 56                	push   $0x56
  jmp alltraps
801060f1:	e9 19 f8 ff ff       	jmp    8010590f <alltraps>
...
801060f8:	6a 57                	push   $0x57
  jmp alltraps
801060fa:	e9 10 f8 ff ff       	jmp    8010590f <alltraps>
...
80106101:	6a 58                	push   $0x58
  jmp alltraps
80106103:	e9 07 f8 ff ff       	jmp    8010590f <alltraps>
...
8010610a:	6a 59                	push   $0x59
  jmp alltraps
8010610c:	e9 fe f7 ff ff       	jmp    8010590f <alltraps>
...
80106113:	6a 5a                	push   $0x5a
  jmp alltraps
80106115:	e9 f5 f7 ff ff       	jmp    8010590f <alltraps>
...
8010611c:	6a 5b                	push   $0x5b
  jmp alltraps
8010611e:	e9 ec f7 ff ff       	jmp    8010590f <alltraps>
...
80106125:	6a 5c                	push   $0x5c
  jmp alltraps
80106127:	e9 e3 f7 ff ff       	jmp    8010590f <alltraps>
...
8010612e:	6a 5d                	push   $0x5d
  jmp alltraps
80106130:	e9 da f7 ff ff       	jmp    8010590f <alltraps>
...
80106137:	6a 5e                	push   $0x5e
  jmp alltraps
80106139:	e9 d1 f7 ff ff       	jmp    8010590f <alltraps>
...
80106140:	6a 5f                	push   $0x5f
  jmp alltraps
80106142:	e9 c8 f7 ff ff       	jmp    8010590f <alltraps>
...
80106149:	6a 60                	push   $0x60
  jmp alltraps
8010614b:	e9 bf f7 ff ff       	jmp    8010590f <alltraps>
...
80106152:	6a 61                	push   $0x61
  jmp alltraps
80106154:	e9 b6 f7 ff ff       	jmp    8010590f <alltraps>
...
8010615b:	6a 62                	push   $0x62
  jmp alltraps
8010615d:	e9 ad f7 ff ff       	jmp    8010590f <alltraps>
...
80106164:	6a 63                	push   $0x63
  jmp alltraps
80106166:	e9 a4 f7 ff ff       	jmp    8010590f <alltraps>
...
8010616d:	6a 64                	push   $0x64
  jmp alltraps
8010616f:	e9 9b f7 ff ff       	jmp    8010590f <alltraps>
...
80106176:	6a 65                	push   $0x65
  jmp alltraps
80106178:	e9 92 f7 ff ff       	jmp    8010590f <alltraps>
...
8010617f:	6a 66                	push   $0x66
  jmp alltraps
80106181:	e9 89 f7 ff ff       	jmp    8010590f <alltraps>
...
80106188:	6a 67                	push   $0x67
  jmp alltraps
8010618a:	e9 80 f7 ff ff       	jmp    8010590f <alltraps>
...
80106191:	6a 68                	push   $0x68
  jmp alltraps
80106193:	e9 77 f7 ff ff       	jmp    8010590f <alltraps>
...
8010619a:	6a 69                	push   $0x69
  jmp alltraps
8010619c:	e9 6e f7 ff ff       	jmp    8010590f <alltraps>
...
801061a3:	6a 6a                	push   $0x6a
  jmp alltraps
801061a5:	e9 65 f7 ff ff       	jmp    8010590f <alltraps>
...
801061ac:	6a 6b                	push   $0x6b
  jmp alltraps
801061ae:	e9 5c f7 ff ff       	jmp    8010590f <alltraps>
...
801061b5:	6a 6c                	push   $0x6c
  jmp alltraps
801061b7:	e9 53 f7 ff ff       	jmp    8010590f <alltraps>
...
801061be:	6a 6d                	push   $0x6d
  jmp alltraps
801061c0:	e9 4a f7 ff ff       	jmp    8010590f <alltraps>
...
801061c7:	6a 6e                	push   $0x6e
  jmp alltraps
801061c9:	e9 41 f7 ff ff       	jmp    8010590f <alltraps>
...
801061d0:	6a 6f                	push   $0x6f
  jmp alltraps
801061d2:	e9 38 f7 ff ff       	jmp    8010590f <alltraps>
...
801061d9:	6a 70                	push   $0x70
  jmp alltraps
801061db:	e9 2f f7 ff ff       	jmp    8010590f <alltraps>
...
801061e2:	6a 71                	push   $0x71
  jmp alltraps
801061e4:	e9 26 f7 ff ff       	jmp    8010590f <alltraps>
...
801061eb:	6a 72                	push   $0x72
  jmp alltraps
801061ed:	e9 1d f7 ff ff       	jmp    8010590f <alltraps>
...
801061f4:	6a 73                	push   $0x73
  jmp alltraps
801061f6:	e9 14 f7 ff ff       	jmp    8010590f <alltraps>
...
801061fd:	6a 74                	push   $0x74
  jmp alltraps
801061ff:	e9 0b f7 ff ff       	jmp    8010590f <alltraps>
...
80106206:	6a 75                	push   $0x75
  jmp alltraps
80106208:	e9 02 f7 ff ff       	jmp    8010590f <alltraps>
...
8010620f:	6a 76                	push   $0x76
  jmp alltraps
80106211:	e9 f9 f6 ff ff       	jmp    8010590f <alltraps>
...
80106218:	6a 77                	push   $0x77
  jmp alltraps
8010621a:	e9 f0 f6 ff ff       	jmp    8010590f <alltraps>
...
80106221:	6a 78                	push   $0x78
  jmp alltraps
80106223:	e9 e7 f6 ff ff       	jmp    8010590f <alltraps>
...
8010622a:	6a 79                	push   $0x79
  jmp alltraps
8010622c:	e9 de f6 ff ff       	jmp    8010590f <alltraps>
...
80106233:	6a 7a                	push   $0x7a
  jmp alltraps
80106235:	e9 d5 f6 ff ff       	jmp    8010590f <alltraps>
...
8010623c:	6a 7b                	push   $0x7b
  jmp alltraps
8010623e:	e9 cc f6 ff ff       	jmp    8010590f <alltraps>
...
80106245:	6a 7c                	push   $0x7c
  jmp alltraps
80106247:	e9 c3 f6 ff ff       	jmp    8010590f <alltraps>
...
8010624e:	6a 7d                	push   $0x7d
  jmp alltraps
80106250:	e9 ba f6 ff ff       	jmp    8010590f <alltraps>
...
80106257:	6a 7e                	push   $0x7e
  jmp alltraps
80106259:	e9 b1 f6 ff ff       	jmp    8010590f <alltraps>
...
80106260:	6a 7f                	push   $0x7f
  jmp alltraps
80106262:	e9 a8 f6 ff ff       	jmp    8010590f <alltraps>
...
80106269:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010626e:	e9 9c f6 ff ff       	jmp    8010590f <alltraps>
...
80106275:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010627a:	e9 90 f6 ff ff       	jmp    8010590f <alltraps>
...
80106281:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106286:	e9 84 f6 ff ff       	jmp    8010590f <alltraps>
...
8010628d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106292:	e9 78 f6 ff ff       	jmp    8010590f <alltraps>
...
80106299:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010629e:	e9 6c f6 ff ff       	jmp    8010590f <alltraps>
...
801062a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801062aa:	e9 60 f6 ff ff       	jmp    8010590f <alltraps>
...
801062b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801062b6:	e9 54 f6 ff ff       	jmp    8010590f <alltraps>
...
801062bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062c2:	e9 48 f6 ff ff       	jmp    8010590f <alltraps>
...
801062c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062ce:	e9 3c f6 ff ff       	jmp    8010590f <alltraps>
...
801062d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062da:	e9 30 f6 ff ff       	jmp    8010590f <alltraps>
...
801062e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062e6:	e9 24 f6 ff ff       	jmp    8010590f <alltraps>
...
801062ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062f2:	e9 18 f6 ff ff       	jmp    8010590f <alltraps>
...
801062f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062fe:	e9 0c f6 ff ff       	jmp    8010590f <alltraps>
...
80106305:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010630a:	e9 00 f6 ff ff       	jmp    8010590f <alltraps>
...
80106311:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106316:	e9 f4 f5 ff ff       	jmp    8010590f <alltraps>
...
8010631d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106322:	e9 e8 f5 ff ff       	jmp    8010590f <alltraps>
...
80106329:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010632e:	e9 dc f5 ff ff       	jmp    8010590f <alltraps>
...
80106335:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010633a:	e9 d0 f5 ff ff       	jmp    8010590f <alltraps>
...
80106341:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106346:	e9 c4 f5 ff ff       	jmp    8010590f <alltraps>
...
8010634d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106352:	e9 b8 f5 ff ff       	jmp    8010590f <alltraps>
...
80106359:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010635e:	e9 ac f5 ff ff       	jmp    8010590f <alltraps>
...
80106365:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010636a:	e9 a0 f5 ff ff       	jmp    8010590f <alltraps>
...
80106371:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106376:	e9 94 f5 ff ff       	jmp    8010590f <alltraps>
...
8010637d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106382:	e9 88 f5 ff ff       	jmp    8010590f <alltraps>
...
80106389:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010638e:	e9 7c f5 ff ff       	jmp    8010590f <alltraps>
...
80106395:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010639a:	e9 70 f5 ff ff       	jmp    8010590f <alltraps>
...
801063a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801063a6:	e9 64 f5 ff ff       	jmp    8010590f <alltraps>
...
801063ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801063b2:	e9 58 f5 ff ff       	jmp    8010590f <alltraps>
...
801063b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801063be:	e9 4c f5 ff ff       	jmp    8010590f <alltraps>
...
801063c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063ca:	e9 40 f5 ff ff       	jmp    8010590f <alltraps>
...
801063d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063d6:	e9 34 f5 ff ff       	jmp    8010590f <alltraps>
...
801063dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063e2:	e9 28 f5 ff ff       	jmp    8010590f <alltraps>
...
801063e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ee:	e9 1c f5 ff ff       	jmp    8010590f <alltraps>
...
801063f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063fa:	e9 10 f5 ff ff       	jmp    8010590f <alltraps>
...
80106401:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106406:	e9 04 f5 ff ff       	jmp    8010590f <alltraps>
...
8010640d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106412:	e9 f8 f4 ff ff       	jmp    8010590f <alltraps>
...
80106419:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010641e:	e9 ec f4 ff ff       	jmp    8010590f <alltraps>
...
80106425:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010642a:	e9 e0 f4 ff ff       	jmp    8010590f <alltraps>
...
80106431:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106436:	e9 d4 f4 ff ff       	jmp    8010590f <alltraps>
...
8010643d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106442:	e9 c8 f4 ff ff       	jmp    8010590f <alltraps>
...
80106449:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010644e:	e9 bc f4 ff ff       	jmp    8010590f <alltraps>
...
80106455:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010645a:	e9 b0 f4 ff ff       	jmp    8010590f <alltraps>
...
80106461:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106466:	e9 a4 f4 ff ff       	jmp    8010590f <alltraps>
...
8010646d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106472:	e9 98 f4 ff ff       	jmp    8010590f <alltraps>
...
80106479:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010647e:	e9 8c f4 ff ff       	jmp    8010590f <alltraps>
...
80106485:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010648a:	e9 80 f4 ff ff       	jmp    8010590f <alltraps>
...
80106491:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106496:	e9 74 f4 ff ff       	jmp    8010590f <alltraps>
...
8010649d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801064a2:	e9 68 f4 ff ff       	jmp    8010590f <alltraps>
...
801064a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801064ae:	e9 5c f4 ff ff       	jmp    8010590f <alltraps>
...
801064b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801064ba:	e9 50 f4 ff ff       	jmp    8010590f <alltraps>
...
801064c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064c6:	e9 44 f4 ff ff       	jmp    8010590f <alltraps>
...
801064cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064d2:	e9 38 f4 ff ff       	jmp    8010590f <alltraps>
...
801064d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064de:	e9 2c f4 ff ff       	jmp    8010590f <alltraps>
...
801064e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ea:	e9 20 f4 ff ff       	jmp    8010590f <alltraps>
...
801064f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064f6:	e9 14 f4 ff ff       	jmp    8010590f <alltraps>
...
801064fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106502:	e9 08 f4 ff ff       	jmp    8010590f <alltraps>
...
80106509:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010650e:	e9 fc f3 ff ff       	jmp    8010590f <alltraps>
...
80106515:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010651a:	e9 f0 f3 ff ff       	jmp    8010590f <alltraps>
...
80106521:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106526:	e9 e4 f3 ff ff       	jmp    8010590f <alltraps>
...
8010652d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106532:	e9 d8 f3 ff ff       	jmp    8010590f <alltraps>
...
80106539:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010653e:	e9 cc f3 ff ff       	jmp    8010590f <alltraps>
...
80106545:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010654a:	e9 c0 f3 ff ff       	jmp    8010590f <alltraps>
...
80106551:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106556:	e9 b4 f3 ff ff       	jmp    8010590f <alltraps>
...
8010655d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106562:	e9 a8 f3 ff ff       	jmp    8010590f <alltraps>
...
80106569:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010656e:	e9 9c f3 ff ff       	jmp    8010590f <alltraps>
...
80106575:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010657a:	e9 90 f3 ff ff       	jmp    8010590f <alltraps>
...
80106581:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106586:	e9 84 f3 ff ff       	jmp    8010590f <alltraps>
...
8010658d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106592:	e9 78 f3 ff ff       	jmp    8010590f <alltraps>
...
80106599:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010659e:	e9 6c f3 ff ff       	jmp    8010590f <alltraps>
...
801065a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801065aa:	e9 60 f3 ff ff       	jmp    8010590f <alltraps>
...
801065b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801065b6:	e9 54 f3 ff ff       	jmp    8010590f <alltraps>
...
801065bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065c2:	e9 48 f3 ff ff       	jmp    8010590f <alltraps>
...
801065c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065ce:	e9 3c f3 ff ff       	jmp    8010590f <alltraps>
...
801065d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065da:	e9 30 f3 ff ff       	jmp    8010590f <alltraps>
...
801065e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065e6:	e9 24 f3 ff ff       	jmp    8010590f <alltraps>
...
801065ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065f2:	e9 18 f3 ff ff       	jmp    8010590f <alltraps>
...
801065f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065fe:	e9 0c f3 ff ff       	jmp    8010590f <alltraps>
...
80106605:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010660a:	e9 00 f3 ff ff       	jmp    8010590f <alltraps>
...
80106611:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106616:	e9 f4 f2 ff ff       	jmp    8010590f <alltraps>
...
8010661d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106622:	e9 e8 f2 ff ff       	jmp    8010590f <alltraps>
...
80106629:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010662e:	e9 dc f2 ff ff       	jmp    8010590f <alltraps>
...
80106635:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010663a:	e9 d0 f2 ff ff       	jmp    8010590f <alltraps>
...
80106641:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106646:	e9 c4 f2 ff ff       	jmp    8010590f <alltraps>
...
8010664d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106652:	e9 b8 f2 ff ff       	jmp    8010590f <alltraps>
...
80106659:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010665e:	e9 ac f2 ff ff       	jmp    8010590f <alltraps>
...
80106665:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010666a:	e9 a0 f2 ff ff       	jmp    8010590f <alltraps>
...
80106671:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106676:	e9 94 f2 ff ff       	jmp    8010590f <alltraps>
...
8010667d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106682:	e9 88 f2 ff ff       	jmp    8010590f <alltraps>
...
80106689:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010668e:	e9 7c f2 ff ff       	jmp    8010590f <alltraps>
...
80106695:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010669a:	e9 70 f2 ff ff       	jmp    8010590f <alltraps>
...
801066a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801066a6:	e9 64 f2 ff ff       	jmp    8010590f <alltraps>
...
801066ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801066b2:	e9 58 f2 ff ff       	jmp    8010590f <alltraps>
...
801066b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801066be:	e9 4c f2 ff ff       	jmp    8010590f <alltraps>
...
801066c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066ca:	e9 40 f2 ff ff       	jmp    8010590f <alltraps>
...
801066d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066d6:	e9 34 f2 ff ff       	jmp    8010590f <alltraps>
...
801066dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066e2:	e9 28 f2 ff ff       	jmp    8010590f <alltraps>
...
801066e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066ee:	e9 1c f2 ff ff       	jmp    8010590f <alltraps>
...
801066f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066fa:	e9 10 f2 ff ff       	jmp    8010590f <alltraps>
...
80106701:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106706:	e9 04 f2 ff ff       	jmp    8010590f <alltraps>
...
8010670d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106712:	e9 f8 f1 ff ff       	jmp    8010590f <alltraps>
...
80106719:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010671e:	e9 ec f1 ff ff       	jmp    8010590f <alltraps>
...
80106725:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010672a:	e9 e0 f1 ff ff       	jmp    8010590f <alltraps>
...
80106731:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106736:	e9 d4 f1 ff ff       	jmp    8010590f <alltraps>
...
8010673d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106742:	e9 c8 f1 ff ff       	jmp    8010590f <alltraps>
...
80106749:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010674e:	e9 bc f1 ff ff       	jmp    8010590f <alltraps>
...
80106755:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010675a:	e9 b0 f1 ff ff       	jmp    8010590f <alltraps>
...
80106761:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106766:	e9 a4 f1 ff ff       	jmp    8010590f <alltraps>
...
8010676d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106772:	e9 98 f1 ff ff       	jmp    8010590f <alltraps>
...
80106779:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010677e:	e9 8c f1 ff ff       	jmp    8010590f <alltraps>
...
80106785:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010678a:	e9 80 f1 ff ff       	jmp    8010590f <alltraps>
...
80106791:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106796:	e9 74 f1 ff ff       	jmp    8010590f <alltraps>
...
8010679d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801067a2:	e9 68 f1 ff ff       	jmp    8010590f <alltraps>
...
801067a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801067ae:	e9 5c f1 ff ff       	jmp    8010590f <alltraps>
...
801067b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801067ba:	e9 50 f1 ff ff       	jmp    8010590f <alltraps>
...
801067c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067c6:	e9 44 f1 ff ff       	jmp    8010590f <alltraps>
...
801067cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067d2:	e9 38 f1 ff ff       	jmp    8010590f <alltraps>
...
801067d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067de:	e9 2c f1 ff ff       	jmp    8010590f <alltraps>
...
801067e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ea:	e9 20 f1 ff ff       	jmp    8010590f <alltraps>
...
801067f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067f6:	e9 14 f1 ff ff       	jmp    8010590f <alltraps>
...
801067fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106802:	e9 08 f1 ff ff       	jmp    8010590f <alltraps>
...
80106809:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010680e:	e9 fc f0 ff ff       	jmp    8010590f <alltraps>
...
80106815:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010681a:	e9 f0 f0 ff ff       	jmp    8010590f <alltraps>
...
80106821:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106826:	e9 e4 f0 ff ff       	jmp    8010590f <alltraps>
...
8010682d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106832:	e9 d8 f0 ff ff       	jmp    8010590f <alltraps>
...
80106839:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010683e:	e9 cc f0 ff ff       	jmp    8010590f <alltraps>
...
80106845:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010684a:	e9 c0 f0 ff ff       	jmp    8010590f <alltraps>
...
80106851:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106856:	e9 b4 f0 ff ff       	jmp    8010590f <alltraps>
...
8010685d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106862:	e9 a8 f0 ff ff       	jmp    8010590f <alltraps>
...
801068b4:	e8 17 bc ff ff       	call   801024d0 <kalloc>
...
8010696d:	68 24 7b 10 80       	push   $0x80107b24
...
801069c4:	e8 57 b9 ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106a23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a26:	e8 a5 cd ff ff       	call   801037d0 <cpuid>
...
80106af4:	0f 84 c2 00 00 00    	je     80106bbc <switchuvm+0xec>
  pushcli();
80106afa:	e8 31 d9 ff ff       	call   80104430 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106aff:	e8 4c cc ff ff       	call   80103750 <mycpu>
80106b04:	89 c6                	mov    %eax,%esi
80106b06:	e8 45 cc ff ff       	call   80103750 <mycpu>
80106b0b:	89 c7                	mov    %eax,%edi
80106b0d:	e8 3e cc ff ff       	call   80103750 <mycpu>
80106b12:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b15:	83 c7 08             	add    $0x8,%edi
80106b18:	e8 33 cc ff ff       	call   80103750 <mycpu>
...
80106bfb:	77 49                	ja     80106c46 <inituvm+0x66>
  mem = kalloc();
80106bfd:	e8 ce b8 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c0f:	e8 fc d9 ff ff       	call   80104610 <memset>
...
80106c40:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c41:	e9 7a da ff ff       	jmp    801046c0 <memmove>
    panic("inituvm: more than a page");
80106c46:	83 ec 0c             	sub    $0xc,%esp
80106c49:	68 69 7b 10 80       	push   $0x80107b69
...
80106cd1:	e8 9a ac ff ff       	call   80101970 <readi>
...
80106d6b:	e8 a0 d8 ff ff       	call   80104610 <memset>
...
80106d99:	0f 86 81 00 00 00    	jbe    80106e20 <allocuvm+0x100>
    mem = kalloc();
80106d9f:	e8 2c b7 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106dad:	68 a1 7b 10 80       	push   $0x80107ba1
...
80106de3:	68 b9 7b 10 80       	push   $0x80107bb9
...
80106e0b:	e8 10 b5 ff ff       	call   80102320 <kfree>
      return 0;
...
80106ece:	e8 4d b4 ff ff       	call   80102320 <kfree>
...
80106ee3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ee4:	e9 37 b4 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106ee9:	83 ec 0c             	sub    $0xc,%esp
80106eec:	68 d5 7b 10 80       	push   $0x80107bd5
...
80106f05:	e8 c6 b5 ff ff       	call   801024d0 <kalloc>
...
80106f20:	e8 eb d6 ff ff       	call   80104610 <memset>
...
80106f8b:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fbf:	68 e6 7b 10 80       	push   $0x80107be6
...
80107010:	e8 ab d6 ff ff       	call   801046c0 <memmove>
...
80107065:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107068:	e8 63 b4 ff ff       	call   801024d0 <kalloc>
...
8010713f:	e8 7c d5 ff ff       	call   801046c0 <memmove>
    len -= n;
    buf += n;
