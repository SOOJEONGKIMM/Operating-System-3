...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 d3 79 10 80 	movl   $0x801079d3,(%esp)
...
80101a15:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a17:	e8 94 2b 00 00       	call   801045b0 <memmove>
    brelse(bp);
...
80101b13:	e8 98 2a 00 00       	call   801045b0 <memmove>
    log_write(bp);
...
80101c0d:	e8 0e 2a 00 00       	call   80104620 <strncmp>
      continue;
...
80101c99:	e8 52 27 00 00       	call   801043f0 <acquire>
  ip->ref++;
...
80101d05:	e8 a6 28 00 00       	call   801045b0 <memmove>
    path++;
...
80101d98:	e8 13 28 00 00       	call   801045b0 <memmove>
    name[len] = 0;
...
80101e8d:	e8 ee 27 00 00       	call   80104680 <strncpy>
  de.inum = inum;
...
80101ed8:	68 6e 77 10 80       	push   $0x8010776e
...
8010209e:	e8 4d 23 00 00       	call   801043f0 <acquire>
...
8010211f:	e8 8c 23 00 00       	call   801044b0 <release>
...
8010213e:	e8 1d 21 00 00       	call   80104260 <holdingsleep>
...
80102178:	e8 73 22 00 00       	call   801043f0 <acquire>
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 c5 22 00 00       	jmp    801044b0 <release>
801021eb:	90                   	nop
...
80102352:	e8 a9 21 00 00       	call   80104500 <memset>
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 20 21 00 00       	jmp    801044b0 <release>
    acquire(&kmem.lock);
80102390:	83 ec 0c             	sub    $0xc,%esp
80102393:	68 40 26 11 80       	push   $0x80112640
80102398:	e8 53 20 00 00       	call   801043f0 <acquire>
...
80102503:	e8 e8 1e 00 00       	call   801043f0 <acquire>
  r = kmem.freelist;
...
80102531:	e8 7a 1f 00 00       	call   801044b0 <release>
  return (char*)r;
...
80102947:	e8 04 1c 00 00       	call   80104550 <memcmp>
...
80102a74:	e8 37 1b 00 00       	call   801045b0 <memmove>
...
80102bbb:	e8 30 18 00 00       	call   801043f0 <acquire>
...
80102c0c:	e8 9f 18 00 00       	call   801044b0 <release>
      break;
    }
  }
}
...
80102c2e:	e8 bd 17 00 00       	call   801043f0 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 3f 18 00 00       	call   801044b0 <release>
}
...
80102cc6:	e8 e5 18 00 00       	call   801045b0 <memmove>
...
80102d0f:	e8 dc 16 00 00       	call   801043f0 <acquire>
    wakeup(&log);
...
80102d31:	e8 7a 17 00 00       	call   801044b0 <release>
...
80102d5c:	e8 4f 17 00 00       	call   801044b0 <release>
...
80102dbe:	e8 2d 16 00 00       	call   801043f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 9e 16 00 00       	jmp    801044b0 <release>
...
80102f24:	e8 87 16 00 00       	call   801045b0 <memmove>
...
80103004:	e8 47 15 00 00       	call   80104550 <memcmp>
...
801030c2:	e8 89 14 00 00       	call   80104550 <memcmp>
...
8010336f:	e8 7c 10 00 00       	call   801043f0 <acquire>
  if(writable){
...
801033b3:	5d                   	pop    %ebp
    release(&p->lock);
801033b4:	e9 f7 10 00 00       	jmp    801044b0 <release>
...
801033e4:	e8 c7 10 00 00       	call   801044b0 <release>
    kfree((char*)p);
...
8010340d:	e8 de 0f 00 00       	call   801043f0 <acquire>
  for(i = 0; i < n; i++){
...
801034a4:	e8 07 10 00 00       	call   801044b0 <release>
        return -1;
...
801034fb:	e8 b0 0f 00 00       	call   801044b0 <release>
  return n;
...
80103520:	e8 cb 0e 00 00       	call   801043f0 <acquire>
...
8010358e:	e8 1d 0f 00 00       	call   801044b0 <release>
      return -1;
...
801035ef:	e8 bc 0e 00 00       	call   801044b0 <release>
  return i;
...
80103621:	e8 ca 0d 00 00       	call   801043f0 <acquire>
...
8010365c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103662:	e8 49 0e 00 00       	call   801044b0 <release>
...
80103684:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 85 57 10 80 	movl   $0x80105785,0x14(%eax)
  p->context = (struct context*)sp;
...
80103696:	e8 65 0e 00 00       	call   80104500 <memset>
...
80103a41:	e8 9a 0c 00 00       	call   801046e0 <safestrcpy>
  pid = np->pid;
...
80103b0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b12:	e8 24 0c 00 00       	call   8010473b <swtch>
      switchkvm();
...
80103bb3:	e8 83 0b 00 00       	call   8010473b <swtch>
  mycpu()->intena = intena;
...
8010403b:	68 d3 79 10 80       	push   $0x801079d3
...
80104068:	8b 14 85 60 76 10 80 	mov    -0x7fef89a0(,%eax,4),%edx
      state = "???";
...
801040ee:	e8 fd 02 00 00       	call   801043f0 <acquire>
...
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104107:	83 c2 7c             	add    $0x7c,%edx
8010410a:	81 fa 54 4c 11 80    	cmp    $0x80114c54,%edx
...
8010411a:	e8 91 03 00 00       	call   801044b0 <release>
...
8010413e:	e8 ad 02 00 00       	call   801043f0 <acquire>
...
80104157:	8b 5a 10             	mov    0x10(%edx),%ebx
  for(i=0,p=ptable.proc;p<&ptable.proc[NPROC];p++)
8010415a:	83 c2 7c             	add    $0x7c,%edx
8010415d:	81 fa 54 4c 11 80    	cmp    $0x80114c54,%edx
...
8010416d:	e8 3e 03 00 00       	call   801044b0 <release>
  return maxpid;
...
8010418a:	68 78 76 10 80       	push   $0x80107678
...
801043a5:	68 83 76 10 80       	push   $0x80107683
801043aa:	e8 e1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043af:	83 ec 0c             	sub    $0xc,%esp
801043b2:	68 9a 76 10 80       	push   $0x8010769a
...
80104497:	68 a1 76 10 80       	push   $0x801076a1
...
801044ec:	68 a9 76 10 80       	push   $0x801076a9
...
80104907:	83 fa 18             	cmp    $0x18,%edx
8010490a:	77 1c                	ja     80104928 <syscall+0x38>
8010490c:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
...
80104967:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010496a:	e8 a1 d5 ff ff       	call   80101f10 <nameiparent>
...
8010498e:	e8 2d d2 ff ff       	call   80101bc0 <dirlookup>
80104993:	83 c4 10             	add    $0x10,%esp
80104996:	85 c0                	test   %eax,%eax
80104998:	89 c7                	mov    %eax,%edi
8010499a:	74 34                	je     801049d0 <create+0x80>
    iunlockput(dp);
...
801049b5:	0f 85 95 00 00 00    	jne    80104a50 <create+0x100>
801049bb:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
801049c0:	0f 85 8a 00 00 00    	jne    80104a50 <create+0x100>
...
801049da:	e8 41 cb ff ff       	call   80101520 <ialloc>
...
80104a11:	e8 ca cb ff ff       	call   801015e0 <iupdate>
...
80104a28:	e8 03 d4 ff ff       	call   80101e30 <dirlink>
...
80104a3c:	e8 df ce ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104a54:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104a56:	e8 c5 ce ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104a84:	68 64 77 10 80       	push   $0x80107764
80104a89:	57                   	push   %edi
80104a8a:	e8 a1 d3 ff ff       	call   80101e30 <dirlink>
...
80104a9c:	68 63 77 10 80       	push   $0x80107763
80104aa1:	57                   	push   %edi
80104aa2:	e8 89 d3 ff ff       	call   80101e30 <dirlink>
...
80104d62:	0f 88 e2 00 00 00    	js     80104e4a <sys_link+0x11a>
  begin_op();
80104d68:	e8 43 de ff ff       	call   80102bb0 <begin_op>
  if((ip = namei(old)) == 0){
80104d6d:	83 ec 0c             	sub    $0xc,%esp
80104d70:	ff 75 d4             	pushl  -0x2c(%ebp)
80104d73:	e8 78 d1 ff ff       	call   80101ef0 <namei>
...
80104dbb:	e8 50 d1 ff ff       	call   80101f10 <nameiparent>
...
80104de3:	e8 48 d0 ff ff       	call   80101e30 <dirlink>
...
80104e3d:	e8 de ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104e42:	e8 d9 dd ff ff       	call   80102c20 <end_op>
  return -1;
...
80104e6d:	eb 9b                	jmp    80104e0a <sys_link+0xda>
    end_op();
80104e6f:	e8 ac dd ff ff       	call   80102c20 <end_op>
    return -1;
...
80104eae:	e8 5d d0 ff ff       	call   80101f10 <nameiparent>
...
80104ec9:	58                   	pop    %eax
80104eca:	5a                   	pop    %edx
80104ecb:	68 64 77 10 80       	push   $0x80107764
80104ed0:	53                   	push   %ebx
80104ed1:	e8 ca cc ff ff       	call   80101ba0 <namecmp>
...
80104ee4:	68 63 77 10 80       	push   $0x80107763
80104ee9:	53                   	push   %ebx
80104eea:	e8 b1 cc ff ff       	call   80101ba0 <namecmp>
...
80104f03:	e8 b8 cc ff ff       	call   80101bc0 <dirlookup>
...
80104f4d:	e8 1e cb ff ff       	call   80101a70 <writei>
...
80104f82:	e8 99 c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104f87:	e8 94 dc ff ff       	call   80102c20 <end_op>
  return 0;
...
80104fe8:	e8 33 c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104fed:	e8 2e dc ff ff       	call   80102c20 <end_op>
  return -1;
...
801050ad:	e8 3e ce ff ff       	call   80101ef0 <namei>
...
8010510c:	e8 5f c6 ff ff       	call   80101770 <iunlock>
  end_op();
...
8010518f:	e8 8c c7 ff ff       	call   80101920 <iunlockput>
    end_op();
80105194:	e8 87 da ff ff       	call   80102c20 <end_op>
    return -1;
...
801052df:	e8 0c cc ff ff       	call   80101ef0 <namei>
...
8010547c:	e8 cf dd ff ff       	call   80103250 <pipealloc>
...
80105543:	83 ec 08             	sub    $0x8,%esp
  exit();
80105546:	e8 c5 e6 ff ff       	call   80103c10 <exit>
...
80105553:	5d                   	pop    %ebp
  return wait();
80105554:	e9 f7 e8 ff ff       	jmp    80103e50 <wait>
...
8010557e:	e8 1d ea ff ff       	call   80103fa0 <kill>
...
8010564d:	e8 3e e7 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
...
cprintf("helloxv6\n");
801056e6:	68 a9 77 10 80       	push   $0x801077a9
...
80105706:	8d 45 08             	lea    0x8(%ebp),%eax
80105709:	6a 04                	push   $0x4
8010570b:	50                   	push   %eax
8010570c:	6a 00                	push   $0x0
8010570e:	e8 3d f1 ff ff       	call   80104850 <argptr>
cprintf("hello %s\n",name);
80105713:	58                   	pop    %eax
80105714:	5a                   	pop    %edx
80105715:	ff 75 08             	pushl  0x8(%ebp)
80105718:	68 b3 77 10 80       	push   $0x801077b3
8010571d:	e8 3e af ff ff       	call   80100660 <cprintf>
return 0;
}
...
80105736:	e8 a5 e9 ff ff       	call   801040e0 <getnumproc>
8010573b:	83 ec 08             	sub    $0x8,%esp
8010573e:	50                   	push   %eax
8010573f:	68 d0 77 10 80       	push   $0x801077d0
80105744:	e8 17 af ff ff       	call   80100660 <cprintf>
  return 0;
}
...
80105756:	e8 d5 e9 ff ff       	call   80104130 <getmaxpid>
8010575b:	83 ec 08             	sub    $0x8,%esp
8010575e:	50                   	push   %eax
8010575f:	68 bd 77 10 80       	push   $0x801077bd
80105764:	e8 f7 ae ff ff       	call   80100660 <cprintf>
  return 0;
}
...
8010576e:	06                   	push   %es
  pushl %fs
8010576f:	0f a0                	push   %fs
  pushl %gs
80105771:	0f a8                	push   %gs
  pushal
80105773:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105774:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105778:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010577a:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010577c:	54                   	push   %esp
  call trap
8010577d:	e8 be 00 00 00       	call   80105840 <trap>
  addl $4, %esp
80105782:	83 c4 04             	add    $0x4,%esp
...
80105785:	61                   	popa   
  popl %gs
80105786:	0f a9                	pop    %gs
  popl %fs
80105788:	0f a1                	pop    %fs
  popl %es
8010578a:	07                   	pop    %es
  popl %ds
8010578b:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010578c:	83 c4 08             	add    $0x8,%esp
  iret
8010578f:	cf                   	iret   
...
801057de:	00 00 ef 
  initlock(&tickslock, "time");
801057e1:	68 f6 77 10 80       	push   $0x801077f6
...
801057f4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801057fa:	e8 b1 ea ff ff       	call   801042b0 <initlock>
}
...
80105860:	ff 24 85 9c 78 10 80 	jmp    *-0x7fef8764(,%eax,4)
...
801058c5:	68 58 78 10 80       	push   $0x80107858
...
8010595d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105960:	e8 8b ef ff ff       	call   801048f0 <syscall>
    if(myproc()->killed)
...
80105a07:	68 00 78 10 80       	push   $0x80107800
...
80105a68:	e8 83 e9 ff ff       	call   801043f0 <acquire>
      wakeup(&ticks);
...
80105a87:	e8 24 ea ff ff       	call   801044b0 <release>
...
80105aa5:	68 24 78 10 80       	push   $0x80107824
80105aaa:	e8 b1 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105aaf:	83 c4 14             	add    $0x14,%esp
80105ab2:	68 fb 77 10 80       	push   $0x801077fb
...
80105bac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105baf:	bb 1c 79 10 80       	mov    $0x8010791c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105c47:	6a 00                	push   $0x0
  jmp alltraps
80105c49:	e9 1f fb ff ff       	jmp    8010576d <alltraps>
...
80105c50:	6a 01                	push   $0x1
  jmp alltraps
80105c52:	e9 16 fb ff ff       	jmp    8010576d <alltraps>
...
80105c59:	6a 02                	push   $0x2
  jmp alltraps
80105c5b:	e9 0d fb ff ff       	jmp    8010576d <alltraps>
...
80105c62:	6a 03                	push   $0x3
  jmp alltraps
80105c64:	e9 04 fb ff ff       	jmp    8010576d <alltraps>
...
80105c6b:	6a 04                	push   $0x4
  jmp alltraps
80105c6d:	e9 fb fa ff ff       	jmp    8010576d <alltraps>
...
80105c74:	6a 05                	push   $0x5
  jmp alltraps
80105c76:	e9 f2 fa ff ff       	jmp    8010576d <alltraps>
...
80105c7d:	6a 06                	push   $0x6
  jmp alltraps
80105c7f:	e9 e9 fa ff ff       	jmp    8010576d <alltraps>
...
80105c86:	6a 07                	push   $0x7
  jmp alltraps
80105c88:	e9 e0 fa ff ff       	jmp    8010576d <alltraps>
...
80105c8d:	6a 08                	push   $0x8
  jmp alltraps
80105c8f:	e9 d9 fa ff ff       	jmp    8010576d <alltraps>
...
80105c96:	6a 09                	push   $0x9
  jmp alltraps
80105c98:	e9 d0 fa ff ff       	jmp    8010576d <alltraps>
...
80105c9d:	6a 0a                	push   $0xa
  jmp alltraps
80105c9f:	e9 c9 fa ff ff       	jmp    8010576d <alltraps>
...
80105ca4:	6a 0b                	push   $0xb
  jmp alltraps
80105ca6:	e9 c2 fa ff ff       	jmp    8010576d <alltraps>
...
80105cab:	6a 0c                	push   $0xc
  jmp alltraps
80105cad:	e9 bb fa ff ff       	jmp    8010576d <alltraps>
...
80105cb2:	6a 0d                	push   $0xd
  jmp alltraps
80105cb4:	e9 b4 fa ff ff       	jmp    8010576d <alltraps>
...
80105cb9:	6a 0e                	push   $0xe
  jmp alltraps
80105cbb:	e9 ad fa ff ff       	jmp    8010576d <alltraps>
...
80105cc2:	6a 0f                	push   $0xf
  jmp alltraps
80105cc4:	e9 a4 fa ff ff       	jmp    8010576d <alltraps>
...
80105ccb:	6a 10                	push   $0x10
  jmp alltraps
80105ccd:	e9 9b fa ff ff       	jmp    8010576d <alltraps>
...
80105cd2:	6a 11                	push   $0x11
  jmp alltraps
80105cd4:	e9 94 fa ff ff       	jmp    8010576d <alltraps>
...
80105cdb:	6a 12                	push   $0x12
  jmp alltraps
80105cdd:	e9 8b fa ff ff       	jmp    8010576d <alltraps>
...
80105ce4:	6a 13                	push   $0x13
  jmp alltraps
80105ce6:	e9 82 fa ff ff       	jmp    8010576d <alltraps>
...
80105ced:	6a 14                	push   $0x14
  jmp alltraps
80105cef:	e9 79 fa ff ff       	jmp    8010576d <alltraps>
...
80105cf6:	6a 15                	push   $0x15
  jmp alltraps
80105cf8:	e9 70 fa ff ff       	jmp    8010576d <alltraps>
...
80105cff:	6a 16                	push   $0x16
  jmp alltraps
80105d01:	e9 67 fa ff ff       	jmp    8010576d <alltraps>
...
80105d08:	6a 17                	push   $0x17
  jmp alltraps
80105d0a:	e9 5e fa ff ff       	jmp    8010576d <alltraps>
...
80105d11:	6a 18                	push   $0x18
  jmp alltraps
80105d13:	e9 55 fa ff ff       	jmp    8010576d <alltraps>
...
80105d1a:	6a 19                	push   $0x19
  jmp alltraps
80105d1c:	e9 4c fa ff ff       	jmp    8010576d <alltraps>
...
80105d23:	6a 1a                	push   $0x1a
  jmp alltraps
80105d25:	e9 43 fa ff ff       	jmp    8010576d <alltraps>
...
80105d2c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d2e:	e9 3a fa ff ff       	jmp    8010576d <alltraps>
...
80105d35:	6a 1c                	push   $0x1c
  jmp alltraps
80105d37:	e9 31 fa ff ff       	jmp    8010576d <alltraps>
...
80105d3e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d40:	e9 28 fa ff ff       	jmp    8010576d <alltraps>
...
80105d47:	6a 1e                	push   $0x1e
  jmp alltraps
80105d49:	e9 1f fa ff ff       	jmp    8010576d <alltraps>
...
80105d50:	6a 1f                	push   $0x1f
  jmp alltraps
80105d52:	e9 16 fa ff ff       	jmp    8010576d <alltraps>
...
80105d59:	6a 20                	push   $0x20
  jmp alltraps
80105d5b:	e9 0d fa ff ff       	jmp    8010576d <alltraps>
...
80105d62:	6a 21                	push   $0x21
  jmp alltraps
80105d64:	e9 04 fa ff ff       	jmp    8010576d <alltraps>
...
80105d6b:	6a 22                	push   $0x22
  jmp alltraps
80105d6d:	e9 fb f9 ff ff       	jmp    8010576d <alltraps>
...
80105d74:	6a 23                	push   $0x23
  jmp alltraps
80105d76:	e9 f2 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d7d:	6a 24                	push   $0x24
  jmp alltraps
80105d7f:	e9 e9 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d86:	6a 25                	push   $0x25
  jmp alltraps
80105d88:	e9 e0 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d8f:	6a 26                	push   $0x26
  jmp alltraps
80105d91:	e9 d7 f9 ff ff       	jmp    8010576d <alltraps>
...
80105d98:	6a 27                	push   $0x27
  jmp alltraps
80105d9a:	e9 ce f9 ff ff       	jmp    8010576d <alltraps>
...
80105da1:	6a 28                	push   $0x28
  jmp alltraps
80105da3:	e9 c5 f9 ff ff       	jmp    8010576d <alltraps>
...
80105daa:	6a 29                	push   $0x29
  jmp alltraps
80105dac:	e9 bc f9 ff ff       	jmp    8010576d <alltraps>
...
80105db3:	6a 2a                	push   $0x2a
  jmp alltraps
80105db5:	e9 b3 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dbc:	6a 2b                	push   $0x2b
  jmp alltraps
80105dbe:	e9 aa f9 ff ff       	jmp    8010576d <alltraps>
...
80105dc5:	6a 2c                	push   $0x2c
  jmp alltraps
80105dc7:	e9 a1 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dce:	6a 2d                	push   $0x2d
  jmp alltraps
80105dd0:	e9 98 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dd7:	6a 2e                	push   $0x2e
  jmp alltraps
80105dd9:	e9 8f f9 ff ff       	jmp    8010576d <alltraps>
...
80105de0:	6a 2f                	push   $0x2f
  jmp alltraps
80105de2:	e9 86 f9 ff ff       	jmp    8010576d <alltraps>
...
80105de9:	6a 30                	push   $0x30
  jmp alltraps
80105deb:	e9 7d f9 ff ff       	jmp    8010576d <alltraps>
...
80105df2:	6a 31                	push   $0x31
  jmp alltraps
80105df4:	e9 74 f9 ff ff       	jmp    8010576d <alltraps>
...
80105dfb:	6a 32                	push   $0x32
  jmp alltraps
80105dfd:	e9 6b f9 ff ff       	jmp    8010576d <alltraps>
...
80105e04:	6a 33                	push   $0x33
  jmp alltraps
80105e06:	e9 62 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e0d:	6a 34                	push   $0x34
  jmp alltraps
80105e0f:	e9 59 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e16:	6a 35                	push   $0x35
  jmp alltraps
80105e18:	e9 50 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e1f:	6a 36                	push   $0x36
  jmp alltraps
80105e21:	e9 47 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e28:	6a 37                	push   $0x37
  jmp alltraps
80105e2a:	e9 3e f9 ff ff       	jmp    8010576d <alltraps>
...
80105e31:	6a 38                	push   $0x38
  jmp alltraps
80105e33:	e9 35 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e3a:	6a 39                	push   $0x39
  jmp alltraps
80105e3c:	e9 2c f9 ff ff       	jmp    8010576d <alltraps>
...
80105e43:	6a 3a                	push   $0x3a
  jmp alltraps
80105e45:	e9 23 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e4c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e4e:	e9 1a f9 ff ff       	jmp    8010576d <alltraps>
...
80105e55:	6a 3c                	push   $0x3c
  jmp alltraps
80105e57:	e9 11 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e5e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e60:	e9 08 f9 ff ff       	jmp    8010576d <alltraps>
...
80105e67:	6a 3e                	push   $0x3e
  jmp alltraps
80105e69:	e9 ff f8 ff ff       	jmp    8010576d <alltraps>
...
80105e70:	6a 3f                	push   $0x3f
  jmp alltraps
80105e72:	e9 f6 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e79:	6a 40                	push   $0x40
  jmp alltraps
80105e7b:	e9 ed f8 ff ff       	jmp    8010576d <alltraps>
...
80105e82:	6a 41                	push   $0x41
  jmp alltraps
80105e84:	e9 e4 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e8b:	6a 42                	push   $0x42
  jmp alltraps
80105e8d:	e9 db f8 ff ff       	jmp    8010576d <alltraps>
...
80105e94:	6a 43                	push   $0x43
  jmp alltraps
80105e96:	e9 d2 f8 ff ff       	jmp    8010576d <alltraps>
...
80105e9d:	6a 44                	push   $0x44
  jmp alltraps
80105e9f:	e9 c9 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ea6:	6a 45                	push   $0x45
  jmp alltraps
80105ea8:	e9 c0 f8 ff ff       	jmp    8010576d <alltraps>
...
80105eaf:	6a 46                	push   $0x46
  jmp alltraps
80105eb1:	e9 b7 f8 ff ff       	jmp    8010576d <alltraps>
...
80105eb8:	6a 47                	push   $0x47
  jmp alltraps
80105eba:	e9 ae f8 ff ff       	jmp    8010576d <alltraps>
...
80105ec1:	6a 48                	push   $0x48
  jmp alltraps
80105ec3:	e9 a5 f8 ff ff       	jmp    8010576d <alltraps>
...
80105eca:	6a 49                	push   $0x49
  jmp alltraps
80105ecc:	e9 9c f8 ff ff       	jmp    8010576d <alltraps>
...
80105ed3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ed5:	e9 93 f8 ff ff       	jmp    8010576d <alltraps>
...
80105edc:	6a 4b                	push   $0x4b
  jmp alltraps
80105ede:	e9 8a f8 ff ff       	jmp    8010576d <alltraps>
...
80105ee5:	6a 4c                	push   $0x4c
  jmp alltraps
80105ee7:	e9 81 f8 ff ff       	jmp    8010576d <alltraps>
...
80105eee:	6a 4d                	push   $0x4d
  jmp alltraps
80105ef0:	e9 78 f8 ff ff       	jmp    8010576d <alltraps>
...
80105ef7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ef9:	e9 6f f8 ff ff       	jmp    8010576d <alltraps>
...
80105f00:	6a 4f                	push   $0x4f
  jmp alltraps
80105f02:	e9 66 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f09:	6a 50                	push   $0x50
  jmp alltraps
80105f0b:	e9 5d f8 ff ff       	jmp    8010576d <alltraps>
...
80105f12:	6a 51                	push   $0x51
  jmp alltraps
80105f14:	e9 54 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f1b:	6a 52                	push   $0x52
  jmp alltraps
80105f1d:	e9 4b f8 ff ff       	jmp    8010576d <alltraps>
...
80105f24:	6a 53                	push   $0x53
  jmp alltraps
80105f26:	e9 42 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f2d:	6a 54                	push   $0x54
  jmp alltraps
80105f2f:	e9 39 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f36:	6a 55                	push   $0x55
  jmp alltraps
80105f38:	e9 30 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f3f:	6a 56                	push   $0x56
  jmp alltraps
80105f41:	e9 27 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f48:	6a 57                	push   $0x57
  jmp alltraps
80105f4a:	e9 1e f8 ff ff       	jmp    8010576d <alltraps>
...
80105f51:	6a 58                	push   $0x58
  jmp alltraps
80105f53:	e9 15 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f5a:	6a 59                	push   $0x59
  jmp alltraps
80105f5c:	e9 0c f8 ff ff       	jmp    8010576d <alltraps>
...
80105f63:	6a 5a                	push   $0x5a
  jmp alltraps
80105f65:	e9 03 f8 ff ff       	jmp    8010576d <alltraps>
...
80105f6c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f6e:	e9 fa f7 ff ff       	jmp    8010576d <alltraps>
...
80105f75:	6a 5c                	push   $0x5c
  jmp alltraps
80105f77:	e9 f1 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f7e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f80:	e9 e8 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f87:	6a 5e                	push   $0x5e
  jmp alltraps
80105f89:	e9 df f7 ff ff       	jmp    8010576d <alltraps>
...
80105f90:	6a 5f                	push   $0x5f
  jmp alltraps
80105f92:	e9 d6 f7 ff ff       	jmp    8010576d <alltraps>
...
80105f99:	6a 60                	push   $0x60
  jmp alltraps
80105f9b:	e9 cd f7 ff ff       	jmp    8010576d <alltraps>
...
80105fa2:	6a 61                	push   $0x61
  jmp alltraps
80105fa4:	e9 c4 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fab:	6a 62                	push   $0x62
  jmp alltraps
80105fad:	e9 bb f7 ff ff       	jmp    8010576d <alltraps>
...
80105fb4:	6a 63                	push   $0x63
  jmp alltraps
80105fb6:	e9 b2 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fbd:	6a 64                	push   $0x64
  jmp alltraps
80105fbf:	e9 a9 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fc6:	6a 65                	push   $0x65
  jmp alltraps
80105fc8:	e9 a0 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fcf:	6a 66                	push   $0x66
  jmp alltraps
80105fd1:	e9 97 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fd8:	6a 67                	push   $0x67
  jmp alltraps
80105fda:	e9 8e f7 ff ff       	jmp    8010576d <alltraps>
...
80105fe1:	6a 68                	push   $0x68
  jmp alltraps
80105fe3:	e9 85 f7 ff ff       	jmp    8010576d <alltraps>
...
80105fea:	6a 69                	push   $0x69
  jmp alltraps
80105fec:	e9 7c f7 ff ff       	jmp    8010576d <alltraps>
...
80105ff3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ff5:	e9 73 f7 ff ff       	jmp    8010576d <alltraps>
...
80105ffc:	6a 6b                	push   $0x6b
  jmp alltraps
80105ffe:	e9 6a f7 ff ff       	jmp    8010576d <alltraps>
...
80106005:	6a 6c                	push   $0x6c
  jmp alltraps
80106007:	e9 61 f7 ff ff       	jmp    8010576d <alltraps>
...
8010600e:	6a 6d                	push   $0x6d
  jmp alltraps
80106010:	e9 58 f7 ff ff       	jmp    8010576d <alltraps>
...
80106017:	6a 6e                	push   $0x6e
  jmp alltraps
80106019:	e9 4f f7 ff ff       	jmp    8010576d <alltraps>
...
80106020:	6a 6f                	push   $0x6f
  jmp alltraps
80106022:	e9 46 f7 ff ff       	jmp    8010576d <alltraps>
...
80106029:	6a 70                	push   $0x70
  jmp alltraps
8010602b:	e9 3d f7 ff ff       	jmp    8010576d <alltraps>
...
80106032:	6a 71                	push   $0x71
  jmp alltraps
80106034:	e9 34 f7 ff ff       	jmp    8010576d <alltraps>
...
8010603b:	6a 72                	push   $0x72
  jmp alltraps
8010603d:	e9 2b f7 ff ff       	jmp    8010576d <alltraps>
...
80106044:	6a 73                	push   $0x73
  jmp alltraps
80106046:	e9 22 f7 ff ff       	jmp    8010576d <alltraps>
...
8010604d:	6a 74                	push   $0x74
  jmp alltraps
8010604f:	e9 19 f7 ff ff       	jmp    8010576d <alltraps>
...
80106056:	6a 75                	push   $0x75
  jmp alltraps
80106058:	e9 10 f7 ff ff       	jmp    8010576d <alltraps>
...
8010605f:	6a 76                	push   $0x76
  jmp alltraps
80106061:	e9 07 f7 ff ff       	jmp    8010576d <alltraps>
...
80106068:	6a 77                	push   $0x77
  jmp alltraps
8010606a:	e9 fe f6 ff ff       	jmp    8010576d <alltraps>
...
80106071:	6a 78                	push   $0x78
  jmp alltraps
80106073:	e9 f5 f6 ff ff       	jmp    8010576d <alltraps>
...
8010607a:	6a 79                	push   $0x79
  jmp alltraps
8010607c:	e9 ec f6 ff ff       	jmp    8010576d <alltraps>
...
80106083:	6a 7a                	push   $0x7a
  jmp alltraps
80106085:	e9 e3 f6 ff ff       	jmp    8010576d <alltraps>
...
8010608c:	6a 7b                	push   $0x7b
  jmp alltraps
8010608e:	e9 da f6 ff ff       	jmp    8010576d <alltraps>
...
80106095:	6a 7c                	push   $0x7c
  jmp alltraps
80106097:	e9 d1 f6 ff ff       	jmp    8010576d <alltraps>
...
8010609e:	6a 7d                	push   $0x7d
  jmp alltraps
801060a0:	e9 c8 f6 ff ff       	jmp    8010576d <alltraps>
...
801060a7:	6a 7e                	push   $0x7e
  jmp alltraps
801060a9:	e9 bf f6 ff ff       	jmp    8010576d <alltraps>
...
801060b0:	6a 7f                	push   $0x7f
  jmp alltraps
801060b2:	e9 b6 f6 ff ff       	jmp    8010576d <alltraps>
...
801060b9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801060be:	e9 aa f6 ff ff       	jmp    8010576d <alltraps>
...
801060c5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060ca:	e9 9e f6 ff ff       	jmp    8010576d <alltraps>
...
801060d1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060d6:	e9 92 f6 ff ff       	jmp    8010576d <alltraps>
...
801060dd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801060e2:	e9 86 f6 ff ff       	jmp    8010576d <alltraps>
...
801060e9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801060ee:	e9 7a f6 ff ff       	jmp    8010576d <alltraps>
...
801060f5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060fa:	e9 6e f6 ff ff       	jmp    8010576d <alltraps>
...
80106101:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106106:	e9 62 f6 ff ff       	jmp    8010576d <alltraps>
...
8010610d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106112:	e9 56 f6 ff ff       	jmp    8010576d <alltraps>
...
80106119:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010611e:	e9 4a f6 ff ff       	jmp    8010576d <alltraps>
...
80106125:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010612a:	e9 3e f6 ff ff       	jmp    8010576d <alltraps>
...
80106131:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106136:	e9 32 f6 ff ff       	jmp    8010576d <alltraps>
...
8010613d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106142:	e9 26 f6 ff ff       	jmp    8010576d <alltraps>
...
80106149:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010614e:	e9 1a f6 ff ff       	jmp    8010576d <alltraps>
...
80106155:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010615a:	e9 0e f6 ff ff       	jmp    8010576d <alltraps>
...
80106161:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106166:	e9 02 f6 ff ff       	jmp    8010576d <alltraps>
...
8010616d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106172:	e9 f6 f5 ff ff       	jmp    8010576d <alltraps>
...
80106179:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010617e:	e9 ea f5 ff ff       	jmp    8010576d <alltraps>
...
80106185:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010618a:	e9 de f5 ff ff       	jmp    8010576d <alltraps>
...
80106191:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106196:	e9 d2 f5 ff ff       	jmp    8010576d <alltraps>
...
8010619d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801061a2:	e9 c6 f5 ff ff       	jmp    8010576d <alltraps>
...
801061a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801061ae:	e9 ba f5 ff ff       	jmp    8010576d <alltraps>
...
801061b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801061ba:	e9 ae f5 ff ff       	jmp    8010576d <alltraps>
...
801061c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061c6:	e9 a2 f5 ff ff       	jmp    8010576d <alltraps>
...
801061cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061d2:	e9 96 f5 ff ff       	jmp    8010576d <alltraps>
...
801061d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061de:	e9 8a f5 ff ff       	jmp    8010576d <alltraps>
...
801061e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801061ea:	e9 7e f5 ff ff       	jmp    8010576d <alltraps>
...
801061f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061f6:	e9 72 f5 ff ff       	jmp    8010576d <alltraps>
...
801061fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106202:	e9 66 f5 ff ff       	jmp    8010576d <alltraps>
...
80106209:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010620e:	e9 5a f5 ff ff       	jmp    8010576d <alltraps>
...
80106215:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010621a:	e9 4e f5 ff ff       	jmp    8010576d <alltraps>
...
80106221:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106226:	e9 42 f5 ff ff       	jmp    8010576d <alltraps>
...
8010622d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106232:	e9 36 f5 ff ff       	jmp    8010576d <alltraps>
...
80106239:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010623e:	e9 2a f5 ff ff       	jmp    8010576d <alltraps>
...
80106245:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010624a:	e9 1e f5 ff ff       	jmp    8010576d <alltraps>
...
80106251:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106256:	e9 12 f5 ff ff       	jmp    8010576d <alltraps>
...
8010625d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106262:	e9 06 f5 ff ff       	jmp    8010576d <alltraps>
...
80106269:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010626e:	e9 fa f4 ff ff       	jmp    8010576d <alltraps>
...
80106275:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010627a:	e9 ee f4 ff ff       	jmp    8010576d <alltraps>
...
80106281:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106286:	e9 e2 f4 ff ff       	jmp    8010576d <alltraps>
...
8010628d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106292:	e9 d6 f4 ff ff       	jmp    8010576d <alltraps>
...
80106299:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010629e:	e9 ca f4 ff ff       	jmp    8010576d <alltraps>
...
801062a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801062aa:	e9 be f4 ff ff       	jmp    8010576d <alltraps>
...
801062b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801062b6:	e9 b2 f4 ff ff       	jmp    8010576d <alltraps>
...
801062bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062c2:	e9 a6 f4 ff ff       	jmp    8010576d <alltraps>
...
801062c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062ce:	e9 9a f4 ff ff       	jmp    8010576d <alltraps>
...
801062d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062da:	e9 8e f4 ff ff       	jmp    8010576d <alltraps>
...
801062e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801062e6:	e9 82 f4 ff ff       	jmp    8010576d <alltraps>
...
801062ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062f2:	e9 76 f4 ff ff       	jmp    8010576d <alltraps>
...
801062f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062fe:	e9 6a f4 ff ff       	jmp    8010576d <alltraps>
...
80106305:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010630a:	e9 5e f4 ff ff       	jmp    8010576d <alltraps>
...
80106311:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106316:	e9 52 f4 ff ff       	jmp    8010576d <alltraps>
...
8010631d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106322:	e9 46 f4 ff ff       	jmp    8010576d <alltraps>
...
80106329:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010632e:	e9 3a f4 ff ff       	jmp    8010576d <alltraps>
...
80106335:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010633a:	e9 2e f4 ff ff       	jmp    8010576d <alltraps>
...
80106341:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106346:	e9 22 f4 ff ff       	jmp    8010576d <alltraps>
...
8010634d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106352:	e9 16 f4 ff ff       	jmp    8010576d <alltraps>
...
80106359:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010635e:	e9 0a f4 ff ff       	jmp    8010576d <alltraps>
...
80106365:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010636a:	e9 fe f3 ff ff       	jmp    8010576d <alltraps>
...
80106371:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106376:	e9 f2 f3 ff ff       	jmp    8010576d <alltraps>
...
8010637d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106382:	e9 e6 f3 ff ff       	jmp    8010576d <alltraps>
...
80106389:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010638e:	e9 da f3 ff ff       	jmp    8010576d <alltraps>
...
80106395:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010639a:	e9 ce f3 ff ff       	jmp    8010576d <alltraps>
...
801063a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801063a6:	e9 c2 f3 ff ff       	jmp    8010576d <alltraps>
...
801063ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801063b2:	e9 b6 f3 ff ff       	jmp    8010576d <alltraps>
...
801063b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801063be:	e9 aa f3 ff ff       	jmp    8010576d <alltraps>
...
801063c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063ca:	e9 9e f3 ff ff       	jmp    8010576d <alltraps>
...
801063d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063d6:	e9 92 f3 ff ff       	jmp    8010576d <alltraps>
...
801063dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801063e2:	e9 86 f3 ff ff       	jmp    8010576d <alltraps>
...
801063e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801063ee:	e9 7a f3 ff ff       	jmp    8010576d <alltraps>
...
801063f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063fa:	e9 6e f3 ff ff       	jmp    8010576d <alltraps>
...
80106401:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106406:	e9 62 f3 ff ff       	jmp    8010576d <alltraps>
...
8010640d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106412:	e9 56 f3 ff ff       	jmp    8010576d <alltraps>
...
80106419:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010641e:	e9 4a f3 ff ff       	jmp    8010576d <alltraps>
...
80106425:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010642a:	e9 3e f3 ff ff       	jmp    8010576d <alltraps>
...
80106431:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106436:	e9 32 f3 ff ff       	jmp    8010576d <alltraps>
...
8010643d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106442:	e9 26 f3 ff ff       	jmp    8010576d <alltraps>
...
80106449:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010644e:	e9 1a f3 ff ff       	jmp    8010576d <alltraps>
...
80106455:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010645a:	e9 0e f3 ff ff       	jmp    8010576d <alltraps>
...
80106461:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106466:	e9 02 f3 ff ff       	jmp    8010576d <alltraps>
...
8010646d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106472:	e9 f6 f2 ff ff       	jmp    8010576d <alltraps>
...
80106479:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010647e:	e9 ea f2 ff ff       	jmp    8010576d <alltraps>
...
80106485:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010648a:	e9 de f2 ff ff       	jmp    8010576d <alltraps>
...
80106491:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106496:	e9 d2 f2 ff ff       	jmp    8010576d <alltraps>
...
8010649d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801064a2:	e9 c6 f2 ff ff       	jmp    8010576d <alltraps>
...
801064a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801064ae:	e9 ba f2 ff ff       	jmp    8010576d <alltraps>
...
801064b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801064ba:	e9 ae f2 ff ff       	jmp    8010576d <alltraps>
...
801064c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064c6:	e9 a2 f2 ff ff       	jmp    8010576d <alltraps>
...
801064cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064d2:	e9 96 f2 ff ff       	jmp    8010576d <alltraps>
...
801064d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064de:	e9 8a f2 ff ff       	jmp    8010576d <alltraps>
...
801064e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801064ea:	e9 7e f2 ff ff       	jmp    8010576d <alltraps>
...
801064f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064f6:	e9 72 f2 ff ff       	jmp    8010576d <alltraps>
...
801064fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106502:	e9 66 f2 ff ff       	jmp    8010576d <alltraps>
...
80106509:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010650e:	e9 5a f2 ff ff       	jmp    8010576d <alltraps>
...
80106515:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010651a:	e9 4e f2 ff ff       	jmp    8010576d <alltraps>
...
80106521:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106526:	e9 42 f2 ff ff       	jmp    8010576d <alltraps>
...
8010652d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106532:	e9 36 f2 ff ff       	jmp    8010576d <alltraps>
...
80106539:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010653e:	e9 2a f2 ff ff       	jmp    8010576d <alltraps>
...
80106545:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010654a:	e9 1e f2 ff ff       	jmp    8010576d <alltraps>
...
80106551:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106556:	e9 12 f2 ff ff       	jmp    8010576d <alltraps>
...
8010655d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106562:	e9 06 f2 ff ff       	jmp    8010576d <alltraps>
...
80106569:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010656e:	e9 fa f1 ff ff       	jmp    8010576d <alltraps>
...
80106575:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010657a:	e9 ee f1 ff ff       	jmp    8010576d <alltraps>
...
80106581:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106586:	e9 e2 f1 ff ff       	jmp    8010576d <alltraps>
...
8010658d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106592:	e9 d6 f1 ff ff       	jmp    8010576d <alltraps>
...
80106599:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010659e:	e9 ca f1 ff ff       	jmp    8010576d <alltraps>
...
801065a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801065aa:	e9 be f1 ff ff       	jmp    8010576d <alltraps>
...
801065b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801065b6:	e9 b2 f1 ff ff       	jmp    8010576d <alltraps>
...
801065bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065c2:	e9 a6 f1 ff ff       	jmp    8010576d <alltraps>
...
801065c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065ce:	e9 9a f1 ff ff       	jmp    8010576d <alltraps>
...
801065d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065da:	e9 8e f1 ff ff       	jmp    8010576d <alltraps>
...
801065e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801065e6:	e9 82 f1 ff ff       	jmp    8010576d <alltraps>
...
801065ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065f2:	e9 76 f1 ff ff       	jmp    8010576d <alltraps>
...
801065f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065fe:	e9 6a f1 ff ff       	jmp    8010576d <alltraps>
...
80106605:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010660a:	e9 5e f1 ff ff       	jmp    8010576d <alltraps>
...
80106611:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106616:	e9 52 f1 ff ff       	jmp    8010576d <alltraps>
...
8010661d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106622:	e9 46 f1 ff ff       	jmp    8010576d <alltraps>
...
80106629:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010662e:	e9 3a f1 ff ff       	jmp    8010576d <alltraps>
...
80106635:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010663a:	e9 2e f1 ff ff       	jmp    8010576d <alltraps>
...
80106641:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106646:	e9 22 f1 ff ff       	jmp    8010576d <alltraps>
...
8010664d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106652:	e9 16 f1 ff ff       	jmp    8010576d <alltraps>
...
80106659:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010665e:	e9 0a f1 ff ff       	jmp    8010576d <alltraps>
...
80106665:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010666a:	e9 fe f0 ff ff       	jmp    8010576d <alltraps>
...
80106671:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106676:	e9 f2 f0 ff ff       	jmp    8010576d <alltraps>
...
8010667d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106682:	e9 e6 f0 ff ff       	jmp    8010576d <alltraps>
...
80106689:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010668e:	e9 da f0 ff ff       	jmp    8010576d <alltraps>
...
80106695:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010669a:	e9 ce f0 ff ff       	jmp    8010576d <alltraps>
...
801066a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066a6:	e9 c2 f0 ff ff       	jmp    8010576d <alltraps>
...
801066ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066b2:	e9 b6 f0 ff ff       	jmp    8010576d <alltraps>
...
8010671a:	e8 e1 dd ff ff       	call   80104500 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067bd:	68 24 79 10 80       	push   $0x80107924
...
80106a5f:	e8 9c da ff ff       	call   80104500 <memset>
...
80106a90:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a91:	e9 1a db ff ff       	jmp    801045b0 <memmove>
    panic("inituvm: more than a page");
80106a96:	83 ec 0c             	sub    $0xc,%esp
80106a99:	68 69 79 10 80       	push   $0x80107969
...
80106bbb:	e8 40 d9 ff ff       	call   80104500 <memset>
...
80106bfd:	68 a1 79 10 80       	push   $0x801079a1
...
80106c33:	68 b9 79 10 80       	push   $0x801079b9
...
80106d3c:	68 d5 79 10 80       	push   $0x801079d5
...
80106d70:	e8 8b d7 ff ff       	call   80104500 <memset>
...
80106e0f:	68 e6 79 10 80       	push   $0x801079e6
...
80106e60:	e8 4b d7 ff ff       	call   801045b0 <memmove>
...
80106ef9:	68 0a 7a 10 80       	push   $0x80107a0a
80106efe:	e8 8d 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f03:	83 ec 0c             	sub    $0xc,%esp
80106f06:	68 f0 79 10 80       	push   $0x801079f0
...
80106f8f:	e8 1c d6 ff ff       	call   801045b0 <memmove>
    len -= n;
    buf += n;
