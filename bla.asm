...
main(int argc, char *argv[])
{
  ...
  5f:	6a 01                	push   $0x1
  61:	e8 da 03 00 00       	call   440 <printf>
    exit();
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb af 07 00 00       	mov    $0x7af,%ebx
        while(*s != 0){
